 ...
 * Generates a deterministic ghost-lobster SVG per agent seed via FNV-1a + xorshift32.
 * ViewBox: 0 0 100 92.
 */
 ...
 * Boo Zero gets the reserved OpenClaw Red (TINTS[0]); other agents skip index 0.
 */
