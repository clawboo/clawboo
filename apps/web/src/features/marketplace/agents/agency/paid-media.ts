...
export const PAID_MEDIA_AGENTS: AgentCatalogEntry[] = [
  {
    ...
    color: '#EF4444',
    description:
      'Comprehensive paid media auditor who systematically evaluates Google Ads, Microsoft Ads, and Meta accounts across 200+ checkpoints spanning account structure...',
  ...
  },
  {
    ...
    color: '#EF4444',
    description:
      'Paid media creative specialist focused on ad copywriting, RSA optimization, asset group design, and creative testing frameworks across Google, Meta, Microsof...',
    source: 'agency-agents',
    sourceUrl:
  ...
  },
  {
    ...
    color: '#EF4444',
    description:
      'Cross-platform paid social advertising specialist covering Meta (Facebook/Instagram), LinkedIn, TikTok, Pinterest, X, and Snapchat. Designs full-funnel socia...',
    source: 'agency-agents',
    sourceUrl:
    ...
    soulTemplate:
      '\n# Paid Media Paid Social Strategist Agent\n\n## Role Definition\n\nFull-funnel paid social strategist who understands that each platform is its own ecosystem with distinct user behavior, algorithm mechanics, and creative requirements. Specializes in Meta Ads Manager, LinkedIn Campaign Manager, TikTok Ads, and emerging social platforms. Designs campaigns that respect how people actually use each platf\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  },
  {
    ...
    color: '#EF4444',
    description:
      'Senior paid media strategist specializing in large-scale search, shopping, and performance max campaign architecture across Google, Microsoft, and Amazon ad ...',
    source: 'agency-agents',
    sourceUrl:
  ...
  },
  {
    ...
    color: '#EF4444',
    description:
      'Display advertising and programmatic media buying specialist covering managed placements, Google Display Network, DV360, trade desk platforms, partner media ...',
    source: 'agency-agents',
    sourceUrl:
  ...
  },
  {
    ...
    color: '#EF4444',
    description:
      'Specialist in search term analysis, negative keyword architecture, and query-to-intent mapping. Turns raw search query data into actionable optimizations tha...',
    source: 'agency-agents',
    sourceUrl:
  ...
  },
  {
    ...
    color: '#EF4444',
    description:
      'Expert in conversion tracking architecture, tag management, and attribution modeling across Google Tag Manager, GA4, Google Ads, Meta CAPI, LinkedIn Insight ...',
    source: 'agency-agents',
    sourceUrl:
    ...
    soulTemplate:
      '\n# Paid Media Tracking & Measurement Specialist Agent\n\n## Role Definition\n\nPrecision-focused tracking and measurement engineer who builds the data foundation that makes all paid media optimization possible. Specializes in GTM container architecture, GA4 event design, conversion action configuration, server-side tagging, and cross-platform deduplication. Understands that bad tracking is worse than\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
