// MIT License — content sourced from github.com/hesamsheikh/awesome-openclaw-usecases
...
export const AWESOME_OPENCLAW_USECASES: AgentCatalogEntry[] = [
  {
    id: 'awesome-ai-video-editing-operator',
    name: 'Ai Video Editing Operator Boo',
    role: 'Ai Video Editing Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Editing videos usually means opening a timeline editor, dragging clips around, and clicking through menus. For repetitive edits — trimming intros, adding sub...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/ai-video-editing.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'ai-video-editing', 'operator'],
    skillIds: ['api-tester', 'file-reader', 'image-resizer'],
    soulTemplate:
      '# Ai Video Editing Operator\n\n# AI Video Editing via Chat\n\nEditing videos usually means opening a timeline editor, dragging clips around, and clicking through menus. For repetitive edits — trimming intros, adding subtitles to a batch of clips, adjusting color on 10 videos — that manual loop eats hours.\n\nThis use case turns video editing into a conversation. Describe what you want changed, drop the file, and get the result back\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-aionui-cowork-desktop-mcp-once-all-agents',
    name: 'MCP once, all agents Boo',
    role: 'MCP once, all agents',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Use OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-s...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/aionui-cowork-desktop.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'mcp', 'once', 'all', 'agents'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# MCP once, all agents\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-aionui-cowork-desktop-multi-agent-in-one-app',
    name: 'Multi-agent in one app Boo',
    role: 'Multi-agent in one app',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Use OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-s...',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'multi', 'agent', 'one', 'app'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# Multi-agent in one app\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      '# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for install, diagnose, and repair — including **remote rescue** when OpenClaw is down and you’re not at the machine.\n\n## Why OpenClaw + AionUi\n\n| If you want… | AionUi gives you… |\n|---------------|--------------------|\n| **Use OpenClaw with a real desktop UI** | Cowork workspace where you see OpenClaw (and other agents) read/write files, run commands, browse the web — not just terminal/chat. |\n| **Fix OpenClaw when it’s broken and you’re remote** | Open AionUi via **Telegram or WebUI** from anywhere → use the **OpenClaw deployment expert** to run `openclaw doctor`, fix config, restart gateway. Many users rely on this. |\n| **One place for OpenClaw + other agents** | OpenClaw, built-in agent, Claude Code, Codex, etc. in one app; switch or run in parallel, same MCP config for all. |\n| **Remote access to your OpenClaw** | WebUI, Telegram, Lark, DingTalk — talk to the same AionUi instance (and thus OpenClaw) from phone or another device. |\n\n## Pain Point\n\nYou already use OpenClaw from CLI or Telegram, but:\n\n- You want to **see** what the agent is doing (files, terminal, web) instead of inferring from logs.\n- When **OpenClaw won’t connect** and you’re not at the machine, you have no way to run `openclaw doctor` or fix config — you need remote access to something that can repair OpenClaw.\n- You use several CLI agents (OpenClaw, Claude Code, Codex, …) and don’t want to juggle apps or reconfigure MCP for each.\n\n## What It Does\n\n- **OpenClaw as a Cowork agent**: Install AionUi and OpenClaw; AionUi auto-detects OpenClaw. Use OpenClaw from the same Cowork UI — file-aware workspace, visible actions.\n- **Remote OpenClaw rescue**: When OpenClaw is broken or unreachable, open AionUi via **Telegram or WebUI** and use the built-in **OpenClaw deployment expert**. It helps with install, runs `openclaw doctor`, fixes config, restarts gateway, and walks you through recovery. A common pattern for users who run OpenClaw headless or on another machine.\n- **Multi-agent in one app**: Run OpenClaw next to built-in agent (Gemini/OpenAI/Anthropic/Ollama), Claude Code, Codex, and 12+ others — one interface, parallel sessions.\n- **MCP once, all agents**: Configure MCP servers in AionUi once; they sync to OpenClaw and every other agent — no per-agent MCP setup.\n- **Remote access**: Use WebUI, Telegram, Lark, or DingTalk to reach your AionUi instance (and OpenClaw) from anywhere.\n- **Optional automation**: AionUi cron can run OpenClaw (or other agents) on a schedule for 24/7 tasks.\n\n## Skills You Need\n\n- **OpenClaw** (e.g. `npm install -g openclaw@latest`). AionUi’s **OpenClaw Setup** assistant can guide install, gateway, and config.\n- API keys or auth for your models (OpenClaw config + any built-in agent keys in AionUi).\n\n## How to Set It Up\n\n1. **Install AionUi**: [AionUi Releases](https://github.com/iOfficeAI/AionUi/releases) (macOS / Windows / Linux).\n2. **Install OpenClaw** (if needed):\n   ```bash\n   npm install -g openclaw@latest\n   openclaw onboard --install-daemon   # optional: daemon for 24/7\n   ```\n3. **Open AionUi**: It auto-detects OpenClaw. If not, use the in-app **OpenClaw Setup** assistant.\n4. **Create a Cowork session** and choose OpenClaw. Same workspace, MCP, and (if enabled) remote channels.\n\nFor remote access or cron, configure channels and automation in AionUi settings.\n\n## Related Links\n\n- [AionUi GitHub](https://github.com/iOfficeAI/AionUi)\n- [AionUi Website](https://www.aionui.com)\n- [OpenClaw GitHub](https://github.com/openclaw/openclaw)\n- [OpenClaw Docs](https://docs.openclaw.ai)\n',
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- api-tester\n- slack-poster\n- file-reader\n- file-writer\n',
  ...
  {
    id: 'awesome-aionui-cowork-desktop-openclaw-as-a-cowork-agent',
    name: 'OpenClaw as a Cowork agent Boo',
    role: 'OpenClaw as a Cowork agent',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Use OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-s...',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'openclaw', 'cowork', 'agent'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# OpenClaw as a Cowork agent\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      '# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for install, diagnose, and repair — including **remote rescue** when OpenClaw is down and you’re not at the machine.\n\n## Why OpenClaw + AionUi\n\n| If you want… | AionUi gives you… |\n|---------------|--------------------|\n| **Use OpenClaw with a real desktop UI** | Cowork workspace where you see OpenClaw (and other agents) read/write files, run commands, browse the web — not just terminal/chat. |\n| **Fix OpenClaw when it’s broken and you’re remote** | Open AionUi via **Telegram or WebUI** from anywhere → use the **OpenClaw deployment expert** to run `openclaw doctor`, fix config, restart gateway. Many users rely on this. |\n| **One place for OpenClaw + other agents** | OpenClaw, built-in agent, Claude Code, Codex, etc. in one app; switch or run in parallel, same MCP config for all. |\n| **Remote access to your OpenClaw** | WebUI, Telegram, Lark, DingTalk — talk to the same AionUi instance (and thus OpenClaw) from phone or another device. |\n\n## Pain Point\n\nYou already use OpenClaw from CLI or Telegram, but:\n\n- You want to **see** what the agent is doing (files, terminal, web) instead of inferring from logs.\n- When **OpenClaw won’t connect** and you’re not at the machine, you have no way to run `openclaw doctor` or fix config — you need remote access to something that can repair OpenClaw.\n- You use several CLI agents (OpenClaw, Claude Code, Codex, …) and don’t want to juggle apps or reconfigure MCP for each.\n\n## What It Does\n\n- **OpenClaw as a Cowork agent**: Install AionUi and OpenClaw; AionUi auto-detects OpenClaw. Use OpenClaw from the same Cowork UI — file-aware workspace, visible actions.\n- **Remote OpenClaw rescue**: When OpenClaw is broken or unreachable, open AionUi via **Telegram or WebUI** and use the built-in **OpenClaw deployment expert**. It helps with install, runs `openclaw doctor`, fixes config, restarts gateway, and walks you through recovery. A common pattern for users who run OpenClaw headless or on another machine.\n- **Multi-agent in one app**: Run OpenClaw next to built-in agent (Gemini/OpenAI/Anthropic/Ollama), Claude Code, Codex, and 12+ others — one interface, parallel sessions.\n- **MCP once, all agents**: Configure MCP servers in AionUi once; they sync to OpenClaw and every other agent — no per-agent MCP setup.\n- **Remote access**: Use WebUI, Telegram, Lark, or DingTalk to reach your AionUi instance (and OpenClaw) from anywhere.\n- **Optional automation**: AionUi cron can run OpenClaw (or other agents) on a schedule for 24/7 tasks.\n\n## Skills You Need\n\n- **OpenClaw** (e.g. `npm install -g openclaw@latest`). AionUi’s **OpenClaw Setup** assistant can guide install, gateway, and config.\n- API keys or auth for your models (OpenClaw config + any built-in agent keys in AionUi).\n\n## How to Set It Up\n\n1. **Install AionUi**: [AionUi Releases](https://github.com/iOfficeAI/AionUi/releases) (macOS / Windows / Linux).\n2. **Install OpenClaw** (if needed):\n   ```bash\n   npm install -g openclaw@latest\n   openclaw onboard --install-daemon   # optional: daemon for 24/7\n   ```\n3. **Open AionUi**: It auto-detects OpenClaw. If not, use the in-app **OpenClaw Setup** assistant.\n4. **Create a Cowork session** and choose OpenClaw. Same workspace, MCP, and (if enabled) remote channels.\n\nFor remote access or cron, configure channels and automation in AionUi settings.\n\n## Related Links\n\n- [AionUi GitHub](https://github.com/iOfficeAI/AionUi)\n- [AionUi Website](https://www.aionui.com)\n- [OpenClaw GitHub](https://github.com/openclaw/openclaw)\n- [OpenClaw Docs](https://docs.openclaw.ai)\n',
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- api-tester\n- slack-poster\n- file-reader\n- file-writer\n',
  ...
  {
    id: 'awesome-aionui-cowork-desktop-operator',
    name: 'Aionui Cowork Desktop Operator Boo',
    role: 'Aionui Cowork Desktop Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Use OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-s...',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'operator'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# Aionui Cowork Desktop Operator\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      '# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for install, diagnose, and repair — including **remote rescue** when OpenClaw is down and you’re not at the machine.\n\n## Why OpenClaw + AionUi\n\n| If you want… | AionUi gives you… |\n|---------------|--------------------|\n| **Use OpenClaw with a real desktop UI** | Cowork workspace where you see OpenClaw (and other agents) read/write files, run commands, browse the web — not just terminal/chat. |\n| **Fix OpenClaw when it’s broken and you’re remote** | Open AionUi via **Telegram or WebUI** from anywhere → use the **OpenClaw deployment expert** to run `openclaw doctor`, fix config, restart gateway. Many users rely on this. |\n| **One place for OpenClaw + other agents** | OpenClaw, built-in agent, Claude Code, Codex, etc. in one app; switch or run in parallel, same MCP config for all. |\n| **Remote access to your OpenClaw** | WebUI, Telegram, Lark, DingTalk — talk to the same AionUi instance (and thus OpenClaw) from phone or another device. |\n\n## Pain Point\n\nYou already use OpenClaw from CLI or Telegram, but:\n\n- You want to **see** what the agent is doing (files, terminal, web) instead of inferring from logs.\n- When **OpenClaw won’t connect** and you’re not at the machine, you have no way to run `openclaw doctor` or fix config — you need remote access to something that can repair OpenClaw.\n- You use several CLI agents (OpenClaw, Claude Code, Codex, …) and don’t want to juggle apps or reconfigure MCP for each.\n\n## What It Does\n\n- **OpenClaw as a Cowork agent**: Install AionUi and OpenClaw; AionUi auto-detects OpenClaw. Use OpenClaw from the same Cowork UI — file-aware workspace, visible actions.\n- **Remote OpenClaw rescue**: When OpenClaw is broken or unreachable, open AionUi via **Telegram or WebUI** and use the built-in **OpenClaw deployment expert**. It helps with install, runs `openclaw doctor`, fixes config, restarts gateway, and walks you through recovery. A common pattern for users who run OpenClaw headless or on another machine.\n- **Multi-agent in one app**: Run OpenClaw next to built-in agent (Gemini/OpenAI/Anthropic/Ollama), Claude Code, Codex, and 12+ others — one interface, parallel sessions.\n- **MCP once, all agents**: Configure MCP servers in AionUi once; they sync to OpenClaw and every other agent — no per-agent MCP setup.\n- **Remote access**: Use WebUI, Telegram, Lark, or DingTalk to reach your AionUi instance (and OpenClaw) from anywhere.\n- **Optional automation**: AionUi cron can run OpenClaw (or other agents) on a schedule for 24/7 tasks.\n\n## Skills You Need\n\n- **OpenClaw** (e.g. `npm install -g openclaw@latest`). AionUi’s **OpenClaw Setup** assistant can guide install, gateway, and config.\n- API keys or auth for your models (OpenClaw config + any built-in agent keys in AionUi).\n\n## How to Set It Up\n\n1. **Install AionUi**: [AionUi Releases](https://github.com/iOfficeAI/AionUi/releases) (macOS / Windows / Linux).\n2. **Install OpenClaw** (if needed):\n   ```bash\n   npm install -g openclaw@latest\n   openclaw onboard --install-daemon   # optional: daemon for 24/7\n   ```\n3. **Open AionUi**: It auto-detects OpenClaw. If not, use the in-app **OpenClaw Setup** assistant.\n4. **Create a Cowork session** and choose OpenClaw. Same workspace, MCP, and (if enabled) remote channels.\n\nFor remote access or cron, configure channels and automation in AionUi settings.\n\n## Related Links\n\n- [AionUi GitHub](https://github.com/iOfficeAI/AionUi)\n- [AionUi Website](https://www.aionui.com)\n- [OpenClaw GitHub](https://github.com/openclaw/openclaw)\n- [OpenClaw Docs](https://docs.openclaw.ai)\n',
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- api-tester\n- slack-poster\n- file-reader\n- file-writer\n',
  ...
  {
    id: 'awesome-aionui-cowork-desktop-optional-automation',
    name: 'Optional automation Boo',
    role: 'Optional automation',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Use OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-s...',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'optional', 'automation'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# Optional automation\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-aionui-cowork-desktop-remote-access',
    name: 'Remote access Boo',
    role: 'Remote access',
    emoji: '✨',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'remote', 'access'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# Remote access\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-aionui-cowork-desktop-remote-openclaw-rescue',
    name: 'Remote OpenClaw rescue Boo',
    role: 'Remote OpenClaw rescue',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Use OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-s...',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'aionui-cowork-desktop', 'remote', 'openclaw', 'rescue'],
    skillIds: ['bash-executor', 'api-tester', 'slack-poster', 'file-reader', 'file-writer'],
    soulTemplate:
      '# Remote OpenClaw rescue\n\n# OpenClaw as Desktop Cowork (AionUi) — Remote Rescue & Multi-Agent Hub\n\nUse OpenClaw from a desktop Cowork UI, access it from Telegram or WebUI when you’re away, and fix it remotely when it won’t connect. AionUi is a free, open-source app that runs **OpenClaw as a first-class agent** alongside 12+ others (Claude Code, Codex, Qwen Code, etc.), with a built-in **OpenClaw deployment expert** for ins\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-arxiv-paper-reader-operator',
    name: 'Arxiv Paper Reader Operator Boo',
    role: 'Arxiv Paper Reader Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
      'Reading arXiv papers means downloading PDFs, losing context when switching between papers, and struggling to parse dense LaTeX notation. You want to read, an...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/arxiv-paper-reader.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'arxiv-paper-reader', 'operator'],
    skillIds: ['python-executor', 'web-search', 'file-reader'],
    soulTemplate:
      '# Arxiv Paper Reader Operator\n\n# arXiv Paper Reader\n\nReading arXiv papers means downloading PDFs, losing context when switching between papers, and struggling to parse dense LaTeX notation. You want to read, analyze, and compare papers conversationally without leaving your workspace.\n\nThis workflow turns your agent into a research reading assistant:\n\n- Fetch any arXiv paper by ID and get clean, readable text (LaTeX flattened au\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-autonomous-game-dev-pipeline-operator',
    name: 'Autonomous Game Dev Pipeline Operator Boo',
    role: 'Autonomous Game Dev Pipeline Operator',
    emoji: '⚙️',
    color: '#A855F7',
    description:
      '**The Origin Story:** A "LANero of the old school" dad wanted to create a safe, ad-free, and high-quality gaming portal for his daughters, Susana (3) and Jul...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/autonomous-game-dev-pipeline.md',
    domain: 'openclaw',
    category: 'engineering',
    tags: ['openclaw', 'autonomous-game-dev-pipeline', 'operator'],
    skillIds: [
      'linter',
      'web-scraper',
      'pdf-reader',
  ...
  {
    id: 'awesome-autonomous-project-management-decentralized-coordination',
    name: 'Decentralized coordination Boo',
    role: 'Decentralized coordination',
    emoji: '📋',
    color: '#A855F7',
    description:
      'Managing complex projects with multiple parallel workstreams is exhausting. You end up context-switching constantly, tracking status across tools, and manual...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/autonomous-project-management.md',
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'autonomous-project-management', 'decentralized', 'coordination'],
    skillIds: [
      'web-search',
      'api-tester',
      'meeting-notes',
  ...
  {
    id: 'awesome-autonomous-project-management-no-orchestrator-overhead',
    name: 'No orchestrator overhead Boo',
    role: 'No orchestrator overhead',
    emoji: '📋',
    color: '#A855F7',
    description:
      'Managing complex projects with multiple parallel workstreams is exhausting. You end up context-switching constantly, tracking status across tools, and manual...',
    ...
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'autonomous-project-management', 'orchestrator', 'overhead'],
    skillIds: [
      'web-search',
      'api-tester',
      'meeting-notes',
  ...
  {
    id: 'awesome-autonomous-project-management-operator',
    name: 'Autonomous Project Management Operator Boo',
    role: 'Autonomous Project Management Operator',
    emoji: '📋',
    color: '#A855F7',
    description:
      'Managing complex projects with multiple parallel workstreams is exhausting. You end up context-switching constantly, tracking status across tools, and manual...',
    ...
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'autonomous-project-management', 'operator'],
    skillIds: [
      'web-search',
      'api-tester',
      'meeting-notes',
    ...
    soulTemplate:
      '# Autonomous Project Management Operator\n\n# Autonomous Project Management with Subagents\n\nManaging complex projects with multiple parallel workstreams is exhausting. You end up context-switching constantly, tracking status across tools, and manually coordinating handoffs.\n\nThis use case implements a decentralized project management pattern where subagents work autonomously on tasks, coordinating through shared state files rather than a ce\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      '# Autonomous Project Management with Subagents\n\nManaging complex projects with multiple parallel workstreams is exhausting. You end up context-switching constantly, tracking status across tools, and manually coordinating handoffs.\n\nThis use case implements a decentralized project management pattern where subagents work autonomously on tasks, coordinating through shared state files rather than a central orchestrator.\n\n## Pain Point\n\nTraditional orchestrator patterns create bottlenecks—the main agent becomes a traffic cop. For complex projects (multi-repo refactors, research sprints, content pipelines), you need agents that can work in parallel without constant supervision.\n\n## What It Does\n\n- **Decentralized coordination**: Agents read/write to a shared `STATE.yaml` file\n- **Parallel execution**: Multiple subagents work on independent tasks simultaneously\n- **No orchestrator overhead**: Main session stays thin (CEO pattern—strategy only)\n- **Self-documenting**: All task state persists in version-controlled files\n\n## Core Pattern: STATE.yaml\n\nEach project maintains a `STATE.yaml` file that serves as the single source of truth:\n\n```yaml\n# STATE.yaml - Project coordination file\nproject: website-redesign\nupdated: 2026-02-10T14:30:00Z\n\ntasks:\n  - id: homepage-hero\n    status: in_progress\n    owner: pm-frontend\n    started: 2026-02-10T12:00:00Z\n    notes: "Working on responsive layout"\n    \n  - id: api-auth\n    status: done\n    owner: pm-backend\n    completed: 2026-02-10T14:00:00Z\n    output: "src/api/auth.ts"\n    \n  - id: content-migration\n    status: blocked\n    owner: pm-content\n    blocked_by: api-auth\n    notes: "Waiting for new endpoint schema"\n\nnext_actions:\n  - "pm-content: Resume migration now that api-auth is done"\n  - "pm-frontend: Review hero with design team"\n```\n\n## How It Works\n\n1. **Main agent receives task** → spawns subagent with specific scope\n2. **Subagent reads STATE.yaml** → finds its assigned tasks\n3. **Subagent works autonomously** → updates STATE.yaml on progress\n4. **Other agents poll STATE.yaml** → pick up unblocked work\n5. **Main agent checks in periodically** → reviews state, adjusts priorities\n\n## Skills You Need\n\n- `sessions_spawn` / `sessions_send` for subagent management\n- File system access for STATE.yaml\n- Git for state versioning (optional but recommended)\n\n## Setup: AGENTS.md Configuration\n\n```text\n## PM Delegation Pattern\n\nMain session = coordinator ONLY. All execution goes to subagents.\n\nWorkflow:\n1. New task arrives\n2. Check PROJECT_REGISTRY.md for existing PM\n3. If PM exists → sessions_send(label="pm-xxx", message="[task]")\n4. If new project → sessions_spawn(label="pm-xxx", task="[task]")\n5. PM executes, updates STATE.yaml, reports back\n6. Main agent summarizes to user\n\nRules:\n- Main session: 0-2 tool calls max (spawn/send only)\n- PMs own their STATE.yaml files\n- PMs can spawn sub-subagents for parallel subtasks\n- All state changes committed to git\n```\n\n## Example: Spawning a PM\n\n```text\nUser: "Refactor the auth module and update the docs"\n\nMain agent:\n1. Checks registry → no active pm-auth\n2. Spawns: sessions_spawn(\n     label="pm-auth-refactor",\n     task="Refactor auth module, update docs. Track in STATE.yaml"\n   )\n3. Responds: "Spawned pm-auth-refactor. I\'ll report back when done."\n\nPM subagent:\n1. Creates STATE.yaml with task breakdown\n2. Works through tasks, updating status\n3. Commits changes\n4. Reports completion to main\n```\n\n## Key Insights\n\n- **STATE.yaml > orchestrator**: File-based coordination scales better than message-passing\n- **Git as audit log**: Commit STATE.yaml changes for full history\n- **Label conventions matter**: Use `pm-{project}-{scope}` for easy tracking\n- **Thin main session**: The less the main agent does, the faster it responds\n\n## Based On\n\nThis pattern is inspired by [Nicholas Carlini\'s approach](https://nicholas.carlini.com/) to autonomous coding agents—let agents self-organize rather than micromanaging them.\n\n## Related Links\n\n- [OpenClaw Subagent Docs](https://github.com/openclaw/openclaw)\n- [Anthropic: Building Effective Agents](https://www.anthropic.com/research/building-effective-agents)\n',
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- web-search\n- api-tester\n- meeting-notes\n- file-reader\n- file-writer\n- note-taker\n- trend-analyzer\n',
  ...
  {
    id: 'awesome-autonomous-project-management-parallel-execution',
    name: 'Parallel execution Boo',
    ...
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'autonomous-project-management', 'parallel', 'execution'],
    skillIds: [
      'web-search',
      'api-tester',
      'meeting-notes',
  ...
  {
    id: 'awesome-content-factory-operator',
    name: 'Content Factory Operator Boo',
    role: 'Content Factory Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      "You're a content creator juggling research, writing, and design across multiple platforms. Each step — finding trending topics, writing scripts, generating t...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/content-factory.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'content-factory', 'operator'],
    skillIds: [
      'web-search',
      'api-tester',
      'rss-reader',
  ...
  {
    id: 'awesome-content-factory-research-agent',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'content-factory', 'research', 'agent'],
    skillIds: [
      'web-search',
      'api-tester',
      'rss-reader',
  ...
  {
    id: 'awesome-content-factory-thumbnail-agent',
    name: 'Thumbnail Agent Boo',
    role: 'Thumbnail Agent',
    emoji: '✍️',
    color: '#A855F7',
    description:
      "You're a content creator juggling research, writing, and design across multiple platforms. Each step — finding trending topics, writing scripts, generating t...",
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'content-factory', 'thumbnail', 'agent'],
    skillIds: [
      'web-search',
      'api-tester',
      'rss-reader',
  ...
  {
    id: 'awesome-content-factory-writing-agent',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'content-factory', 'writing', 'agent'],
    skillIds: [
      'web-search',
      'api-tester',
      'rss-reader',
  ...
  {
    id: 'awesome-custom-morning-brief-operator',
    name: 'Custom Morning Brief Operator Boo',
    role: 'Custom Morning Brief Operator',
    emoji: '📣',
    color: '#A855F7',
    description:
      'You wake up and spend the first 30 minutes of your day catching up — scrolling news, checking your calendar, reviewing your to-do list, trying to figure out ...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/custom-morning-brief.md',
    domain: 'openclaw',
    category: 'marketing',
    tags: ['openclaw', 'custom-morning-brief', 'operator'],
    skillIds: [
      'web-search',
      'rss-reader',
      'email-draft',
  ...
  {
    id: 'awesome-daily-reddit-digest-operator',
    name: 'Daily Reddit Digest Operator Boo',
    role: 'Daily Reddit Digest Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
    ...
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/daily-reddit-digest.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'daily-reddit-digest', 'operator'],
    skillIds: ['file-reader', 'file-writer'],
    soulTemplate:
      "# Daily Reddit Digest Operator\n\n# Daily Reddit Digest\nRun a daily digest everyday to give you the top performing posts from your favourite subreddits.\n\nWhat to use it for:\n\n• Browsing subreddits (hot/new/top posts)\n• Searching posts by topic\n• Pulling comment threads for context\n• Building shortlists of posts to manually review/reply to later\n\n> It's read-only. No posting, voting, or commenting.\n\n## Skills you Need\n[reddit-reado\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
  ...
  {
    id: 'awesome-daily-youtube-digest-operator',
    name: 'Daily Youtube Digest Operator Boo',
    role: 'Daily Youtube Digest Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Start your day with a personalized summary of new videos from your favorite YouTube channels — no more missing content from creators you actually want to fol...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/daily-youtube-digest.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'daily-youtube-digest', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
    ...
    soulTemplate:
      "# Daily Youtube Digest Operator\n\n# Daily YouTube Digest\n\nStart your day with a personalized summary of new videos from your favorite YouTube channels — no more missing content from creators you actually want to follow.\n\n## Pain Point\n\nYouTube notifications are unreliable. You subscribe to channels, but their new videos never show up in your home feed. They're not in notifications. They just... disappear. This doesn't mean you don\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
  ...
  {
    id: 'awesome-dynamic-dashboard-operator',
    name: 'Dynamic Dashboard Operator Boo',
    role: 'Dynamic Dashboard Operator',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Static dashboards show stale data and require constant manual updates. You want real-time visibility across multiple data sources without building a custom f...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/dynamic-dashboard.md',
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'dynamic-dashboard', 'operator'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-scraper',
  ...
  {
    id: 'awesome-dynamic-dashboard-social-media',
    name: 'Social Media Boo',
    role: 'Social Media',
    emoji: '🛠️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'dynamic-dashboard', 'social', 'media'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-scraper',
  ...
  {
    id: 'awesome-dynamic-dashboard-system-health',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'dynamic-dashboard', 'system', 'health'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-scraper',
  ...
  {
    id: 'awesome-earnings-tracker-operator',
    name: 'Earnings Tracker Operator Boo',
    role: 'Earnings Tracker Operator',
    emoji: '📣',
    color: '#A855F7',
    description:
      'Following earnings season across dozens of tech companies means checking multiple sources and remembering report dates. You want to stay on top of AI/tech ea...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/earnings-tracker.md',
    domain: 'openclaw',
    category: 'marketing',
    tags: ['openclaw', 'earnings-tracker', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'calendar-manager',
  ...
  {
    id: 'awesome-event-guest-confirmation-operator',
    name: 'Event Guest Confirmation Operator Boo',
    role: 'Event Guest Confirmation Operator',
    emoji: '📋',
    color: '#A855F7',
    description:
      "You're hosting an event — a dinner party, a wedding, a company offsite — and you need to confirm attendance from a list of guests. Manually calling 20+ peopl...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/event-guest-confirmation.md',
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'event-guest-confirmation', 'operator'],
    skillIds: ['api-tester', 'meeting-notes', 'file-reader', 'note-taker', 'summarizer'],
    soulTemplate:
      "# Event Guest Confirmation Operator\n\n# Event Guest Confirmation\n\nYou're hosting an event — a dinner party, a wedding, a company offsite — and you need to confirm attendance from a list of guests. Manually calling 20+ people is tedious: you play phone tag, forget who said what, and lose track of dietary restrictions or plus-ones. Texting works sometimes, but people ignore messages. A real phone call gets a much higher response rate.\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
  ...
  {
    id: 'awesome-family-calendar-household-assistant-ambient-message-monitoring',
    name: 'Ambient message monitoring Boo',
    role: 'Ambient message monitoring',
    emoji: '✨',
    color: '#A855F7',
    description:
      "Modern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Impor...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/family-calendar-household-assistant.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'ambient', 'message', 'monitoring'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
  ...
  {
    id: 'awesome-family-calendar-household-assistant-driving-time-buffers',
    name: 'Driving time buffers Boo',
    role: 'Driving time buffers',
    emoji: '✨',
    color: '#A855F7',
    description:
      "Modern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Impor...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'driving', 'time', 'buffers'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
  ...
  {
    id: 'awesome-family-calendar-household-assistant-grocery-coordination',
    name: 'Grocery coordination Boo',
    role: 'Grocery coordination',
    emoji: '✨',
    color: '#A855F7',
    description:
      "Modern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Impor...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'grocery', 'coordination'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
  ...
  {
    id: 'awesome-family-calendar-household-assistant-household-inventory',
    name: 'Household inventory Boo',
    role: 'Household inventory',
    emoji: '✨',
    color: '#A855F7',
    description:
      "Modern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Impor...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'household', 'inventory'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
  ...
  {
    id: 'awesome-family-calendar-household-assistant-morning-briefing',
    name: 'Morning briefing Boo',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'morning', 'briefing'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
  ...
  {
    id: 'awesome-family-calendar-household-assistant-operator',
    name: 'Family Calendar Household Assistant Operator Boo',
    role: 'Family Calendar Household Assistant Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
      "Modern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Impor...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'operator'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
    ...
    soulTemplate:
      "# Family Calendar Household Assistant Operator\n\n# Family Calendar Aggregation & Household Assistant\n\nModern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Important events slip through the cracks because no single view exists. Meanwhile, household coordination (grocery lists, pantry inventory, appointment scheduling) happens through scattered text\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
      '# Family Calendar Aggregation & Household Assistant\n\nModern families juggle five or more calendars — work, personal, shared family, kids\' school, extracurriculars — across different platforms and formats. Important events slip through the cracks because no single view exists. Meanwhile, household coordination (grocery lists, pantry inventory, appointment scheduling) happens through scattered text messages that get buried.\n\nThis use case turns OpenClaw into an always-on household coordinator: aggregating calendars into a morning briefing, monitoring messages for actionable items, and managing household logistics through a shared chat interface.\n\n## Pain Point\n\n- **Calendar fragmentation**: Work calendars have security restrictions preventing sharing. School calendars arrive as PDFs or hand-written websites. Camp schedules live in emails. Manually checking each one every morning is unsustainable — and "copying events across calendars works well until I forget and one slips through the cracks."\n- **Household coordination overhead**: "How much milk do we have?" requires physically checking the fridge, then the basement pantry, then texting back. Multiply this across a week\'s worth of grocery runs.\n- **Missed appointments**: Appointment confirmations arrive via text message and sit there unacted upon — no calendar event, no driving time buffer, no reminder.\n\n## What It Does\n\n- **Morning briefing**: Aggregates all family calendars into a single daily summary delivered via your preferred channel\n- **Ambient message monitoring**: Watches iMessage/text conversations and automatically creates calendar events when it detects appointments (dentist confirmations, meeting plans, etc.)\n- **Driving time buffers**: Adds travel time blocks before and after detected appointments\n- **Household inventory**: Maintains a running inventory of pantry/fridge items that either partner can query from anywhere\n- **Grocery coordination**: Deduplicates ingredients across recipes, tracks what\'s running low, and generates shopping lists\n- **Photo-based input**: Snap a photo of a school calendar or freezer contents and the agent processes it into structured data\n\n## Skills You Need\n\n- Calendar API access (Google Calendar, Apple Calendar via `ical`)\n- `imessage` skill for message monitoring (macOS only)\n- Telegram or Slack for the shared family chat interface\n- File system access for inventory tracking\n- Camera/photo processing for OCR of physical calendars\n\n## How to Set It Up\n\n### 1. Calendar Aggregation\n\nConfigure OpenClaw to pull from all family calendar sources:\n\n```text\n## Calendar Sources\n\nOn morning briefing (8:00 AM):\n\n1. Fetch my Google Work Calendar (read-only OAuth)\n2. Fetch shared Family Google Calendar\n3. Fetch partner\'s calendar (shared view)\n4. Check ~/Documents/school-calendars/ for any new PDFs → OCR and extract events\n5. Check recent emails for calendar attachments or event invitations\n\nCompile into a single briefing:\n- Today\'s events (all calendars, color-coded by source)\n- Upcoming 3-day lookahead for conflicts\n- Any new events added since yesterday\n- Weather context for outdoor events\n\nDeliver via Telegram/Slack family channel.\n```\n\n### 2. Ambient Message Monitoring\n\nThis is the key differentiator — the agent watches passively and acts when it recognizes something actionable:\n\n```text\n## Message Monitoring (HEARTBEAT.md)\n\nEvery 15 minutes:\n1. Check new iMessages across all conversations\n2. Detect appointment-like patterns:\n   - "Your appointment is confirmed for..."\n   - "Can we meet on [date] at [time]?"\n   - "Practice moved to Saturday at 3pm"\n3. When detected:\n   - Create calendar event with details\n   - Add 30-minute driving buffer before AND after\n   - Send confirmation to family Telegram: "Created: Dentist appointment, Tue 2pm. Added drive time 1:30-2:00 and 3:00-3:30."\n   - If relevant to partner, add invite\n4. Detect promise/commitment patterns:\n   - "I\'ll send that over by Friday"\n   - "Let\'s do dinner next week"\n   → Create calendar hold or reminder\n```\n\n### 3. Household Inventory\n\n```text\n## Pantry Tracking\n\nMaintain ~/household/inventory.json with:\n- Item name, quantity, location (fridge/pantry/basement)\n- Last updated timestamp\n- Low-stock threshold\n\nUpdate methods:\n- Photo: User sends photo of fridge/pantry → vision model extracts items\n- Text: "We\'re out of eggs" / "Bought 2 gallons of milk"\n- Receipt: Photo of grocery receipt → update inventory\n\nQuery: Either partner can ask via Telegram:\n- "Do we have butter?" → Check inventory, respond with location and quantity\n- "What\'s running low?" → List items below threshold\n- "Generate grocery list" → Compile low-stock items + any recipe ingredients needed\n```\n\n## Key Insights\n\n- **Ambient > active**: The biggest unlock is the agent acting without being asked. Detecting an appointment in a text message and creating a calendar event with driving buffers — "I didn\'t ask it to do that. It just knew that\'s what I\'d want."\n- **Mac Mini is the sweet spot**: This use case benefits heavily from running on a home Mac Mini — iMessage integration, Apple Calendar, and always-on availability\n- **Start read-only**: Begin with calendar reading and message monitoring before enabling write actions (creating events, sending messages)\n- **Shared Telegram channel**: Gives both partners visibility into what the agent is doing — builds trust and catches errors early\n- **Photo input is underrated**: Snapping a photo of a school calendar PDF or freezer contents is faster than typing — and the vision model handles it well\n\n## Inspired By\n\nThis use case combines several community patterns:\n\n- **Calendar aggregation**: Described by HN user `angiolillo` in [a Hacker News discussion](https://news.ycombinator.com/item?id=46872465), who detailed the pain of checking work, personal, family, and kids\' school calendars separately each morning.\n- **Ambient message monitoring**: Documented by [Sparkry AI](https://sparkryai.substack.com/p/24-hours-with-openclaw-the-ai-setup) — when a wife received a dental appointment text, OpenClaw automatically created a calendar event with 30-minute driving buffers, without being asked. Also confirmed on the [OpenClaw Showcase](https://openclaw.ai/showcase) where `@theaaron` called chat-based calendar management "one of the best uses of an LLM I\'ve ever experienced."\n- **Household coordination**: Brandon Wang\'s [Clawdbot "Linguini"](https://brandon.wang/2026/clawdbot) running on a Mac Mini at home — handling text message follow-ups, creating calendar events from photos, tracking Airbnb prices, processing freezer inventory photos, and coordinating household logistics via iMessage and Slack.\n- **Pantry tracking**: Multiple HN users discussed the value (and challenge) of maintaining household inventory, with `dns_snek` noting: "I forget where I put things down 5 seconds ago... It\'s genuinely a big problem for me because I let things expire."\n\n## Related Links\n\n- [OpenClaw iMessage Skill](https://github.com/openclaw/openclaw)\n- [Google Calendar API](https://developers.google.com/calendar)\n- [Apple Calendar (EventKit)](https://developer.apple.com/documentation/eventkit)\n- [OpenClaw Showcase — Calendar Testimonials](https://openclaw.ai/showcase)\n',
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- web-search\n- pdf-reader\n- api-tester\n- rss-reader\n- json-transformer\n- slack-poster\n- calendar-manager\n- meeting-notes\n- file-reader\n- file-writer\n- zip-handler\n- markdown-renderer\n- trend-analyzer\n- summarizer\n',
  ...
  {
    id: 'awesome-family-calendar-household-assistant-photo-based-input',
    name: 'Photo-based input Boo',
    role: 'Photo-based input',
    emoji: '✨',
    color: '#A855F7',
    description:
      "Modern families juggle five or more calendars — work, personal, shared family, kids' school, extracurriculars — across different platforms and formats. Impor...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'family-calendar-household-assistant', 'photo', 'based', 'input'],
    skillIds: [
      'web-search',
      'pdf-reader',
      'api-tester',
  ...
  {
    id: 'awesome-habit-tracker-accountability-coach-adaptive-nudges',
    name: 'Adaptive nudges Boo',
    role: 'Adaptive nudges',
    emoji: '✨',
    color: '#A855F7',
    description:
      "You've tried every habit tracker app out there. They all work for a week, then you stop opening them. The problem isn't the app — it's that tracking habits i...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/habit-tracker-accountability-coach.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'habit-tracker-accountability-coach', 'adaptive', 'nudges'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
  ...
  {
    id: 'awesome-habit-tracker-accountability-coach-daily-check-ins',
    name: 'Daily check-ins Boo',
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'habit-tracker-accountability-coach', 'daily', 'check', 'ins'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
  ...
  {
    id: 'awesome-habit-tracker-accountability-coach-operator',
    name: 'Habit Tracker Accountability Coach Operator Boo',
    role: 'Habit Tracker Accountability Coach Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
      "You've tried every habit tracker app out there. They all work for a week, then you stop opening them. The problem isn't the app — it's that tracking habits i...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'habit-tracker-accountability-coach', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
    ...
    soulTemplate:
      "# Habit Tracker Accountability Coach Operator\n\n# Habit Tracker & Accountability Coach\n\nYou've tried every habit tracker app out there. They all work for a week, then you stop opening them. The problem isn't the app — it's that tracking habits is passive. What if your agent actively reached out to you, asked how your day went, and adapted its approach based on whether you're on a streak or falling off?\n\nThis use case turns OpenClaw into a proac\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
      "# Habit Tracker & Accountability Coach\n\nYou've tried every habit tracker app out there. They all work for a week, then you stop opening them. The problem isn't the app — it's that tracking habits is passive. What if your agent actively reached out to you, asked how your day went, and adapted its approach based on whether you're on a streak or falling off?\n\nThis use case turns OpenClaw into a proactive accountability partner that checks in with you daily via Telegram or SMS.\n\n## Pain Point\n\nHabit apps rely on you remembering to open them. Push notifications are easy to ignore. What actually works for behavior change is **active accountability** — someone (or something) that asks you directly, celebrates your wins, and nudges you when you slip. This agent does exactly that, without the awkwardness of bugging a friend.\n\n## What It Does\n\n- **Daily check-ins** via Telegram or SMS at times you choose (e.g., 7 AM for morning routine, 9 PM for end-of-day review)\n- **Tracks habits** you define — exercise, reading, meditation, water intake, coding, whatever matters to you\n- **Streak tracking** — knows your current streak for each habit and references it in messages\n- **Adaptive nudges** — adjusts tone based on your performance (encouraging when you're consistent, gently persistent when you miss days)\n- **Weekly reports** — summarizes your week with completion rates, longest streaks, and patterns (e.g., \"You tend to skip workouts on Wednesdays\")\n\n## Skills You Need\n\n- Telegram or SMS integration (Twilio for SMS, or Telegram Bot API)\n- Scheduling / cron for timed check-ins\n- File system or database access for storing habit data\n- Optional: Google Sheets integration for a visual habit dashboard\n\n## How to Set It Up\n\n1. Define your habits and check-in schedule:\n```text\nI want you to be my accountability coach. Track these daily habits for me:\n\n1. Morning workout (check in at 7:30 AM)\n2. Read for 30 minutes (check in at 8:00 PM)\n3. No social media before noon (check in at 12:30 PM)\n4. Drink 8 glasses of water (check in at 6:00 PM)\n\nSend me a Telegram message at each check-in time asking if I completed\nthe habit. Keep track of my streaks in a local file.\n```\n\n2. Set up the tracking and tone:\n```text\nWhen I confirm a habit, respond with a short encouraging message and\nmention my current streak. Example: \"Day 12 of morning workouts. Solid.\"\n\nWhen I miss a habit, don't guilt-trip me. Just acknowledge it and remind\nme why I started. If I miss 3 days in a row, send a longer motivational\nmessage and ask if I want to adjust the goal.\n\nIf I don't respond to a check-in within 2 hours, send one follow-up.\nDon't spam me after that.\n```\n\n3. Add weekly reports:\n```text\nEvery Sunday at 10 AM, send me a weekly summary:\n- Completion rate for each habit\n- Current streaks\n- Best day and worst day\n- One pattern you noticed (e.g., \"You always skip reading on Fridays\")\n- One suggestion for next week\n\nStore all data in ~/habits/log.json so I can review history anytime.\n```\n\n4. Optional — visual dashboard via Google Sheets:\n```text\nAt the end of each day, update a Google Sheet with today's habit data.\nColumns: Date, Workout, Reading, No Social Media, Water, Notes.\nMark completed habits with ✓ and missed with ✗.\n```\n\n## Key Insights\n\n- The **adaptive tone** is what makes this different from a cron job. A static reminder gets ignored. A message that says \"Day 15, don't break it now\" actually motivates.\n- Keep the number of tracked habits small (3-5). Tracking too many leads to check-in fatigue and you'll start ignoring the messages.\n- The weekly pattern analysis is surprisingly useful — you'll discover things like \"I never exercise on days I have early meetings\" and can plan around it.\n- Pairs well with the [Health & Symptom Tracker](health-symptom-tracker.md) if you want to correlate habits with how you feel.\n\n## Related Links\n\n- [Telegram Bot API](https://core.telegram.org/bots/api)\n- [Twilio SMS API](https://www.twilio.com/docs/sms)\n- [Google Sheets API](https://developers.google.com/sheets/api)\n",
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- code-search\n- web-search\n- api-tester\n- json-transformer\n- sql-query\n- slack-poster\n- notification-sender\n- calendar-manager\n- meeting-notes\n- file-reader\n- note-taker\n- trend-analyzer\n- summarizer\n',
  ...
  {
    id: 'awesome-habit-tracker-accountability-coach-streak-tracking',
    name: 'Streak tracking Boo',
    role: 'Streak tracking',
    emoji: '✨',
    color: '#A855F7',
    description:
      "You've tried every habit tracker app out there. They all work for a week, then you stop opening them. The problem isn't the app — it's that tracking habits i...",
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'habit-tracker-accountability-coach', 'streak', 'tracking'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
  ...
  {
    id: 'awesome-habit-tracker-accountability-coach-tracks-habits',
    name: 'Tracks habits Boo',
    role: 'Tracks habits',
    emoji: '✨',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'habit-tracker-accountability-coach', 'tracks', 'habits'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
  ...
  {
    id: 'awesome-habit-tracker-accountability-coach-weekly-reports',
    name: 'Weekly reports Boo',
    role: 'Weekly reports',
    emoji: '✨',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'habit-tracker-accountability-coach', 'weekly', 'reports'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
  ...
  {
    id: 'awesome-health-symptom-tracker-operator',
    name: 'Health Symptom Tracker Operator Boo',
    role: 'Health Symptom Tracker Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
    ...
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/health-symptom-tracker.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'health-symptom-tracker', 'operator'],
    skillIds: ['code-search', 'file-writer', 'markdown-renderer', 'trend-analyzer'],
    soulTemplate:
      '# Health Symptom Tracker Operator\n\n# Health & Symptom Tracker\n\nIdentifying food sensitivities requires consistent logging over time, which is tedious to maintain. You need reminders to log and analysis to spot patterns.\n\nThis workflow tracks food and symptoms automatically:\n\n• Message your food and symptoms in a dedicated Telegram topic and OpenClaw logs everything with timestamps\n• 3x daily reminders (morning, midday, evening) pro\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-hf-papers-research-discovery-operator',
    name: 'Hf Papers Research Discovery Operator Boo',
    role: 'Hf Papers Research Discovery Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
      'Keeping up with ML research means refreshing Hugging Face Papers daily, scanning dozens of titles, clicking into each one for the abstract, and manually cros...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/hf-papers-research-discovery.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'hf-papers-research-discovery', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'meeting-notes',
  ...
  {
    id: 'awesome-inbox-declutter-operator',
    name: 'Inbox Declutter Operator Boo',
    role: 'Inbox Declutter Operator',
    emoji: '🛟',
    color: '#A855F7',
    description:
    ...
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/inbox-declutter.md',
    domain: 'openclaw',
    category: 'support',
    tags: ['openclaw', 'inbox-declutter', 'operator'],
    skillIds: ['email-draft', 'file-reader', 'file-writer'],
    soulTemplate:
      '# Inbox Declutter Operator\n\n# Inbox De-clutter\n\nNewsletters can take up the inbox like nothing else. Often times they pile-up without being opened at all. \n\n## Skills you Need\n[Gmail OAuth Setup](https://clawhub.ai/kai-jar/gmail-oauth).\n\n## How to Set it Up\n1. [optional] Create a new gmail specifically for OpenClaw.\n2. [optional] Unsubscribe from all newsletters from your main email and subscribe to them using the OpenClaw e\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-knowledge-base-rag-operator',
    name: 'Knowledge Base Rag Operator Boo',
    role: 'Knowledge Base Rag Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
    ...
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/knowledge-base-rag.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'knowledge-base-rag', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'pdf-reader',
  ...
  {
    id: 'awesome-latex-paper-writing-operator',
    name: 'Latex Paper Writing Operator Boo',
    role: 'Latex Paper Writing Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
      'Setting up a local LaTeX environment is painful — installing TeX Live takes gigabytes, debugging compilation errors is tedious, and switching between your ed...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/latex-paper-writing.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'latex-paper-writing', 'operator'],
    skillIds: [
      'linter',
      'web-search',
      'pdf-reader',
  ...
  {
    id: 'awesome-local-crm-framework-app-builder',
    name: 'App builder Boo',
    role: 'App builder',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Setting up a CRM that actually works with OpenClaw is painful. You need to wire up databases, build UIs, configure browser automation, connect messaging plat...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/local-crm-framework.md',
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'app', 'builder'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-local-crm-framework-full-browser-automation',
    name: 'Full browser automation Boo',
    role: 'Full browser automation',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Setting up a CRM that actually works with OpenClaw is painful. You need to wire up databases, build UIs, configure browser automation, connect messaging plat...',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'full', 'browser', 'automation'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-local-crm-framework-multiple-views',
    name: 'Multiple views Boo',
    role: 'Multiple views',
    emoji: '💼',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'multiple', 'views'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-local-crm-framework-natural-language-crm',
    name: 'Natural language CRM Boo',
    role: 'Natural language CRM',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Setting up a CRM that actually works with OpenClaw is painful. You need to wire up databases, build UIs, configure browser automation, connect messaging plat...',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'natural', 'language', 'crm'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-local-crm-framework-one-command-setup',
    name: 'One-command setup Boo',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'one', 'command', 'setup'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-local-crm-framework-operator',
    name: 'Local Crm Framework Operator Boo',
    role: 'Local Crm Framework Operator',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Setting up a CRM that actually works with OpenClaw is painful. You need to wire up databases, build UIs, configure browser automation, connect messaging plat...',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'operator'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-local-crm-framework-works-as-a-coding-agent',
    name: 'Works as a coding agent Boo',
    role: 'Works as a coding agent',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Setting up a CRM that actually works with OpenClaw is painful. You need to wire up databases, build UIs, configure browser automation, connect messaging plat...',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'local-crm-framework', 'works', 'coding', 'agent'],
    skillIds: [
      'bash-executor',
      'web-scraper',
      'api-tester',
  ...
  {
    id: 'awesome-market-research-product-factory-operator',
    name: 'Market Research Product Factory Operator Boo',
    role: 'Market Research Product Factory Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
      "You want to build a product but don't know what to build. Or you have a business and need to understand what your customers are struggling with. This workflo...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/market-research-product-factory.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'market-research-product-factory', 'operator'],
    skillIds: ['web-search', 'api-tester', 'note-taker'],
    soulTemplate:
      "# Market Research Product Factory Operator\n\n# Market Research & Product Factory\n\nYou want to build a product but don't know what to build. Or you have a business and need to understand what your customers are struggling with. This workflow uses the Last 30 Days skill to mine Reddit and X for real pain points, then has OpenClaw build solutions to those problems.\n\n## What It Does\n\n- Researches any topic across Reddit and X over the last 30 da\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
  ...
  {
    id: 'awesome-meeting-notes-action-items-creates-tasks',
    name: 'Creates tasks Boo',
    role: 'Creates tasks',
    emoji: '📋',
    color: '#A855F7',
    description:
      'You just finished a 45-minute team call. Now you need to write up the summary, pull out action items, and distribute them to Jira, Linear, or Todoist — manua...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/meeting-notes-action-items.md',
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'meeting-notes-action-items', 'creates', 'tasks'],
    skillIds: [
      'bash-executor',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-meeting-notes-action-items-follows-up',
    name: 'Follows up Boo',
    role: 'Follows up',
    emoji: '📋',
    color: '#A855F7',
    ...
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'meeting-notes-action-items', 'follows'],
    skillIds: [
      'bash-executor',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-meeting-notes-action-items-operator',
    name: 'Meeting Notes Action Items Operator Boo',
    role: 'Meeting Notes Action Items Operator',
    emoji: '📋',
    color: '#A855F7',
    description:
      'You just finished a 45-minute team call. Now you need to write up the summary, pull out action items, and distribute them to Jira, Linear, or Todoist — manua...',
    ...
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'meeting-notes-action-items', 'operator'],
    skillIds: [
      'bash-executor',
      'linter',
      'web-search',
    ...
    soulTemplate:
      "# Meeting Notes Action Items Operator\n\n# Automated Meeting Notes & Action Items\n\nYou just finished a 45-minute team call. Now you need to write up the summary, pull out action items, and distribute them to Jira, Linear, or Todoist — manually. By the time you're done, the next meeting is starting. What if your agent handled all of that the moment the transcript lands?\n\nThis use case turns any meeting transcript into structured notes and\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
      "# Automated Meeting Notes & Action Items\n\nYou just finished a 45-minute team call. Now you need to write up the summary, pull out action items, and distribute them to Jira, Linear, or Todoist — manually. By the time you're done, the next meeting is starting. What if your agent handled all of that the moment the transcript lands?\n\nThis use case turns any meeting transcript into structured notes and automatically creates tasks in your project management tool.\n\n## Pain Point\n\nMeeting notes are tedious but critical. Most people either skip them (and lose context) or spend 20+ minutes writing them up. Action items get forgotten because they live in someone's head or buried in a chat thread. This agent eliminates the gap between \"we discussed it\" and \"it's tracked and assigned.\"\n\n## What It Does\n\n- **Watches** for new meeting transcripts (via Otter.ai export, Google Meet transcript, Zoom recording summary, or a simple paste into chat)\n- **Extracts** key decisions, discussion topics, and action items with owners and deadlines\n- **Creates tasks** in Jira, Linear, Todoist, or Notion — assigned to the right person with context from the meeting\n- **Posts a summary** to Slack or Discord so the whole team has a record\n- **Follows up** — optionally pings assignees before deadlines via scheduled reminders\n\n## Skills You Need\n\n- Jira, Linear, Todoist, or Notion integration (for task creation)\n- Slack or Discord integration (for posting summaries)\n- File system access (for reading transcript files)\n- Scheduling / cron (for follow-up reminders)\n- Optional: Otter.ai, Fireflies.ai, or Google Meet API for automatic transcript retrieval\n\n## How to Set It Up\n\n1. Choose your transcript source. The simplest approach is pasting the transcript directly into chat. For automation, set up a folder watch or API integration.\n\n2. Prompt OpenClaw:\n```text\nI just finished a meeting. Here's the transcript:\n\n[paste transcript or point to file]\n\nPlease:\n1. Write a concise summary (max 5 bullet points) covering key decisions and topics.\n2. Extract ALL action items. For each one, identify:\n   - What needs to be done\n   - Who is responsible (match names to my team)\n   - Deadline (if mentioned, otherwise mark as \"TBD\")\n3. Create a Jira ticket for each action item, assigned to the right person.\n4. Post the full summary to #meeting-notes in Slack.\n```\n\n3. For fully automated pipeline (transcript folder watch):\n```text\nSet up a recurring task: every 30 minutes, check ~/meeting-transcripts/ for\nnew .txt or .vtt files. When you find one:\n\n1. Parse the transcript into a structured summary with action items.\n2. Create tasks in Linear for each action item.\n3. Post the summary to #team-updates in Slack.\n4. Move the processed file to ~/meeting-transcripts/processed/.\n\nFor each action item with a deadline, set a reminder to ping the assignee\nin Slack one day before it's due.\n```\n\n4. Customize the output format:\n```text\nWhen writing meeting summaries, always use this structure:\n- **Date & Attendees** at the top\n- **Key Decisions** — numbered list of what was decided\n- **Action Items** — table with columns: Task, Owner, Deadline, Status\n- **Open Questions** — anything unresolved that needs follow-up\n```\n\n## Key Insights\n\n- The real value isn't in the summary — it's in the **automatic task creation**. Meeting notes that don't become tracked tasks are just documentation theater.\n- Pair this with the [Todoist Task Manager](todoist-task-manager.md) use case for full visibility into agent-created tasks.\n- VTT/SRT subtitle files from Zoom or Google Meet work great as input — they include timestamps which help the agent attribute statements to speakers.\n- Start simple (paste transcript, get summary) and automate incrementally. Don't over-engineer the pipeline before validating the output quality.\n\n## Related Links\n\n- [Otter.ai API](https://otter.ai/)\n- [Jira REST API](https://developer.atlassian.com/cloud/jira/platform/rest/v3/)\n- [Linear API](https://developers.linear.app/)\n- [Slack API](https://api.slack.com/)\n",
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- linter\n- web-search\n- api-tester\n- slack-poster\n- calendar-manager\n- meeting-notes\n- file-reader\n- file-writer\n- zip-handler\n- note-taker\n- summarizer\n',
  ...
  {
    id: 'awesome-meeting-notes-action-items-posts-a-summary',
    name: 'Posts a summary Boo',
    role: 'Posts a summary',
    emoji: '📋',
    color: '#A855F7',
    description:
      'You just finished a 45-minute team call. Now you need to write up the summary, pull out action items, and distribute them to Jira, Linear, or Todoist — manua...',
    ...
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'meeting-notes-action-items', 'posts', 'summary'],
    skillIds: [
      'bash-executor',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-multi-agent-team-business-growth',
    name: 'Business & Growth Boo',
    role: 'Business & Growth',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Solo founders wear every hat — strategy, development, marketing, sales, operations. Context-switching between these roles destroys deep work. Hiring is expen...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/multi-agent-team.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'business', 'growth'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-dev-agent',
    name: 'Dev Agent Boo',
    role: 'Dev Agent',
    emoji: '✍️',
    color: '#A855F7',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'dev', 'agent'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-marketing-agent',
    name: 'Marketing Agent Boo',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'marketing', 'agent'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-operator',
    name: 'Multi Agent Team Operator Boo',
    role: 'Multi Agent Team Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Solo founders wear every hat — strategy, development, marketing, sales, operations. Context-switching between these roles destroys deep work. Hiring is expen...',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'operator'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-parallel-execution',
    name: 'Parallel execution Boo',
    role: 'Parallel execution',
    emoji: '✍️',
    color: '#A855F7',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'parallel', 'execution'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-private-context',
    name: 'Private context Boo',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'private', 'context'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-scheduled-daily-tasks',
    name: 'Scheduled daily tasks Boo',
    role: 'Scheduled daily tasks',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Solo founders wear every hat — strategy, development, marketing, sales, operations. Context-switching between these roles destroys deep work. Hiring is expen...',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'scheduled', 'daily', 'tasks'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-shared-memory',
    name: 'Shared memory Boo',
    role: 'Shared memory',
    emoji: '✍️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'shared', 'memory'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-single-control-plane',
    name: 'Single control plane Boo',
    role: 'Single control plane',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Solo founders wear every hat — strategy, development, marketing, sales, operations. Context-switching between these roles destroys deep work. Hiring is expen...',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'single', 'control', 'plane'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-specialized-agents',
    name: 'Specialized agents Boo',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'specialized', 'agents'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-agent-team-strategy-lead',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'multi-agent-team', 'strategy', 'lead'],
    skillIds: [
      'code-search',
      'test-runner',
      'linter',
  ...
  {
    id: 'awesome-multi-channel-assistant-operator',
    name: 'Multi Channel Assistant Operator Boo',
    role: 'Multi Channel Assistant Operator',
    emoji: '🛟',
    color: '#A855F7',
    description:
      'Context-switching between apps to manage tasks, schedule events, send messages, and track work is exhausting. You want one interface that routes to all your ...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/multi-channel-assistant.md',
    domain: 'openclaw',
    category: 'support',
    tags: ['openclaw', 'multi-channel-assistant', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'api-tester',
  ...
  {
    id: 'awesome-multi-channel-customer-service-ai-auto-responses',
    name: 'AI auto-responses Boo',
    role: 'AI auto-responses',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Small businesses juggle WhatsApp, Instagram DMs, emails, and Google Reviews across multiple apps. Customers expect instant responses 24/7, but hiring staff f...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/multi-channel-customer-service.md',
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'multi-channel-customer-service', 'auto', 'responses'],
    skillIds: [
      'test-runner',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-multi-channel-customer-service-business-context',
    name: 'Business context Boo',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'multi-channel-customer-service', 'business', 'context'],
    skillIds: [
      'test-runner',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-multi-channel-customer-service-human-handoff',
    name: 'Human handoff Boo',
    role: 'Human handoff',
    emoji: '💼',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'multi-channel-customer-service', 'human', 'handoff'],
    skillIds: [
      'test-runner',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-multi-channel-customer-service-operator',
    name: 'Multi Channel Customer Service Operator Boo',
    role: 'Multi Channel Customer Service Operator',
    emoji: '💼',
    color: '#A855F7',
    description:
      'Small businesses juggle WhatsApp, Instagram DMs, emails, and Google Reviews across multiple apps. Customers expect instant responses 24/7, but hiring staff f...',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'multi-channel-customer-service', 'operator'],
    skillIds: [
      'test-runner',
      'linter',
      'web-search',
    ...
    soulTemplate:
      '# Multi Channel Customer Service Operator\n\n# Multi-Channel AI Customer Service Platform\n\nSmall businesses juggle WhatsApp, Instagram DMs, emails, and Google Reviews across multiple apps. Customers expect instant responses 24/7, but hiring staff for round-the-clock coverage is expensive.\n\nThis use case consolidates all customer touchpoints into a single AI-powered inbox that responds intelligently on your behalf.\n\n## What It Does\n\n- **Unifi\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      "# Multi-Channel AI Customer Service Platform\n\nSmall businesses juggle WhatsApp, Instagram DMs, emails, and Google Reviews across multiple apps. Customers expect instant responses 24/7, but hiring staff for round-the-clock coverage is expensive.\n\nThis use case consolidates all customer touchpoints into a single AI-powered inbox that responds intelligently on your behalf.\n\n## What It Does\n\n- **Unified inbox**: WhatsApp Business, Instagram DMs, Gmail, and Google Reviews in one place\n- **AI auto-responses**: Handles FAQs, appointment requests, and common inquiries automatically\n- **Human handoff**: Escalates complex issues or flags them for review\n- **Test mode**: Demo the system to clients without affecting real customers\n- **Business context**: Trained on your services, pricing, and policies\n\n## Real Business Example\n\nAt Futurist Systems, we deploy this for local service businesses (restaurants, clinics, salons). One restaurant reduced response time from 4+ hours to under 2 minutes, handling 80% of inquiries automatically.\n\n## Skills You Need\n\n- WhatsApp Business API integration\n- Instagram Graph API (via Meta Business)\n- `gog` CLI for Gmail\n- Google Business Profile API for reviews\n- Message routing logic in AGENTS.md\n\n## How to Set It Up\n\n1. **Connect channels** via OpenClaw config:\n   - WhatsApp Business API (through 360dialog or official API)\n   - Instagram via Meta Business Suite\n   - Gmail via `gog` OAuth\n   - Google Business Profile API token\n\n2. **Create business knowledge base**:\n   - Services and pricing\n   - Business hours and location\n   - FAQ responses\n   - Escalation triggers (e.g., complaints, refund requests)\n\n3. **Configure AGENTS.md** with routing logic:\n\n```text\n## Customer Service Mode\n\nWhen receiving customer messages:\n\n1. Identify channel (WhatsApp/Instagram/Email/Review)\n2. Check if test mode is enabled for this client\n3. Classify intent:\n   - FAQ → respond from knowledge base\n   - Appointment → check availability, confirm booking\n   - Complaint → flag for human review, acknowledge receipt\n   - Review → thank for feedback, address concerns\n\nResponse style:\n- Friendly, professional, concise\n- Match the customer's language (ES/EN/UA)\n- Never invent information not in knowledge base\n- Sign off with business name\n\nTest mode:\n- Prefix responses with [TEST]\n- Log but don't send to real channels\n```\n\n4. **Set up heartbeat checks** for response monitoring:\n\n```text\n## Heartbeat: Customer Service Check\n\nEvery 30 minutes:\n- Check for unanswered messages > 5 min old\n- Alert if response queue is backing up\n- Log daily response metrics\n```\n\n## Key Insights\n\n- **Language detection matters**: Auto-detect and respond in customer's language\n- **Test mode is essential**: Clients need to see it work before going live\n- **Handoff rules**: Define clear escalation triggers to avoid AI overreach\n- **Response templates**: Pre-approved templates for sensitive topics (refunds, complaints)\n\n## Related Links\n\n- [WhatsApp Business API](https://developers.facebook.com/docs/whatsapp)\n- [Instagram Messaging API](https://developers.facebook.com/docs/instagram-api/guides/messaging)\n- [Google Business Profile API](https://developers.google.com/my-business)\n",
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- test-runner\n- linter\n- web-search\n- api-tester\n- rss-reader\n- email-draft\n- slack-poster\n- calendar-manager\n- file-writer\n',
  ...
  {
    id: 'awesome-multi-channel-customer-service-test-mode',
    name: 'Test mode Boo',
    role: 'Test mode',
    emoji: '💼',
    color: '#A855F7',
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'multi-channel-customer-service', 'test', 'mode'],
    skillIds: [
      'test-runner',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-multi-channel-customer-service-unified-inbox',
    name: 'Unified inbox Boo',
    role: 'Unified inbox',
    emoji: '💼',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'multi-channel-customer-service', 'unified', 'inbox'],
    skillIds: [
      'test-runner',
      'linter',
      'web-search',
  ...
  {
    id: 'awesome-multi-source-tech-news-digest-operator',
    name: 'Multi Source Tech News Digest Operator Boo',
    role: 'Multi Source Tech News Digest Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Automatically aggregate, score, and deliver tech news from 109+ sources across RSS, Twitter/X, GitHub releases, and web search — all managed through natural ...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/multi-source-tech-news-digest.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'multi-source-tech-news-digest', 'operator'],
    skillIds: ['code-search', 'linter', 'web-search', 'api-tester', 'rss-reader', 'email-draft'],
    soulTemplate:
      '# Multi Source Tech News Digest Operator\n\n# Multi-Source Tech News Digest\n\nAutomatically aggregate, score, and deliver tech news from 109+ sources across RSS, Twitter/X, GitHub releases, and web search — all managed through natural language.\n\n## Pain Point\n\nStaying updated across AI, open-source, and frontier tech requires checking dozens of RSS feeds, Twitter accounts, GitHub repos, and news sites daily. Manual curation is time-consuming\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-n8n-workflow-orchestration-credential-isolation',
    name: 'Credential isolation Boo',
    role: 'Credential isolation',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Letting your AI agent directly manage API keys and call external services is a recipe for security incidents. Every new integration means another credential ...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/n8n-workflow-orchestration.md',
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'n8n-workflow-orchestration', 'credential', 'isolation'],
    skillIds: [
      'bash-executor',
      'test-runner',
      'api-tester',
  ...
  {
    id: 'awesome-n8n-workflow-orchestration-lockable-workflows',
    name: 'Lockable workflows Boo',
    role: 'Lockable workflows',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Letting your AI agent directly manage API keys and call external services is a recipe for security incidents. Every new integration means another credential ...',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'n8n-workflow-orchestration', 'lockable', 'workflows'],
    skillIds: [
      'bash-executor',
      'test-runner',
      'api-tester',
  ...
  {
    id: 'awesome-n8n-workflow-orchestration-operator',
    name: 'N8n Workflow Orchestration Operator Boo',
    role: 'N8n Workflow Orchestration Operator',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Letting your AI agent directly manage API keys and call external services is a recipe for security incidents. Every new integration means another credential ...',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'n8n-workflow-orchestration', 'operator'],
    skillIds: [
      'bash-executor',
      'test-runner',
      'api-tester',
    ...
    soulTemplate:
      '# N8n Workflow Orchestration Operator\n\n# OpenClaw + n8n Workflow Orchestration\n\nLetting your AI agent directly manage API keys and call external services is a recipe for security incidents. Every new integration means another credential in `.env.local`, another surface for the agent to accidentally leak or misuse.\n\nThis use case describes a pattern where OpenClaw delegates all external API interactions to n8n workflows via webhooks — t\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      '# OpenClaw + n8n Workflow Orchestration\n\nLetting your AI agent directly manage API keys and call external services is a recipe for security incidents. Every new integration means another credential in `.env.local`, another surface for the agent to accidentally leak or misuse.\n\nThis use case describes a pattern where OpenClaw delegates all external API interactions to n8n workflows via webhooks — the agent never touches credentials, and every integration is visually inspectable and lockable.\n\n## Pain Point\n\nWhen OpenClaw handles everything directly, you get three compounding problems:\n\n- **No visibility**: It\'s hard to inspect what the agent actually built when it\'s buried in JavaScript skill files or shell scripts\n- **Credential sprawl**: Every API key lives in the agent\'s environment, one bad commit away from exposure\n- **Wasted tokens**: Deterministic sub-tasks (send an email, update a spreadsheet) burn LLM reasoning tokens when they could run as simple workflows\n\n## What It Does\n\n- **Proxy pattern**: OpenClaw writes n8n workflows with incoming webhooks, then calls those webhooks for all future API interactions\n- **Credential isolation**: API keys live in n8n\'s credential store — the agent only knows the webhook URL\n- **Visual debugging**: Every workflow is inspectable in n8n\'s drag-and-drop UI\n- **Lockable workflows**: Once a workflow is built and tested, you lock it so the agent can\'t modify how it interacts with the API\n- **Safeguard steps**: You can add validation, rate limiting, and approval gates in n8n before any external call executes\n\n## How It Works\n\n1. **Agent designs the workflow**: Tell OpenClaw what you need (e.g., "create a workflow that sends a Slack message when a new GitHub issue is labeled `urgent`")\n2. **Agent builds it in n8n**: OpenClaw creates the workflow via n8n\'s API, including an incoming webhook trigger\n3. **You add credentials**: Open n8n\'s UI, add your Slack token / GitHub token manually\n4. **You lock the workflow**: Prevent further modifications by the agent\n5. **Agent calls the webhook**: From now on, OpenClaw calls `http://n8n:5678/webhook/my-workflow` with a JSON payload — it never sees the API key\n\n```text\n┌──────────────┐     webhook call      ┌─────────────────┐     API call     ┌──────────────┐\n│   OpenClaw   │ ───────────────────→  │   n8n Workflow   │ ─────────────→  │  External    │\n│   (agent)    │   (no credentials)    │  (locked, with   │  (credentials   │  Service     │\n│              │                       │   API keys)      │   stay here)    │  (Slack, etc)│\n└──────────────┘                       └─────────────────┘                  └──────────────┘\n```\n\n## Skills You Need\n\n- `n8n` API access (for creating/triggering workflows)\n- `fetch` or `curl` for webhook calls\n- Docker (if using the pre-configured stack)\n- n8n credential management (manual, one-time setup per integration)\n\n## How to Set It Up\n\n### Option 1: Pre-configured Docker Stack\n\nA community-maintained Docker Compose setup ([openclaw-n8n-stack](https://github.com/caprihan/openclaw-n8n-stack)) pre-wires everything on a shared Docker network:\n\n```bash\ngit clone https://github.com/caprihan/openclaw-n8n-stack.git\ncd openclaw-n8n-stack\ncp .env.template .env\n# Add your Anthropic API key to .env\ndocker-compose up -d\n```\n\nThis gives you:\n- OpenClaw on port 3456\n- n8n on port 5678\n- Shared Docker network so OpenClaw can call `http://n8n:5678/webhook/...` directly\n- Pre-built workflow templates (multi-LLM fact-checking, email triage, social monitoring)\n\n### Option 2: Manual Setup\n\n1. Install n8n (`npm install n8n -g` or run via Docker)\n2. Configure OpenClaw to know the n8n base URL\n3. Add this to your AGENTS.md:\n\n```text\n## n8n Integration Pattern\n\nWhen I need to interact with external APIs:\n\n1. NEVER store API keys in my environment or skill files\n2. Check if an n8n workflow already exists for this integration\n3. If not, create one via n8n API with a webhook trigger\n4. Notify the user to add credentials and lock the workflow\n5. For all future calls, use the webhook URL with a JSON payload\n\nWorkflow naming: openclaw-{service}-{action}\nExample: openclaw-slack-send-message\n\nWebhook call format:\ncurl -X POST http://n8n:5678/webhook/{workflow-name} \\\n  -H "Content-Type: application/json" \\\n  -d \'{"channel": "#general", "message": "Hello from OpenClaw"}\'\n```\n\n## Key Insights\n\n- **Three wins in one**: Observability (visual UI), security (credential isolation), and performance (deterministic workflows don\'t burn tokens)\n- **Lock after testing**: The "build → test → lock" cycle is critical — without locking, the agent can silently modify workflows\n- **n8n has 400+ integrations**: Most external services you\'d want to connect already have n8n nodes, saving the agent from writing custom API calls\n- **Audit trail for free**: n8n logs every workflow execution with input/output data\n\n## Inspired By\n\nThis pattern was described by [Simon Høiberg](https://x.com/SimonHoiberg/status/2020843874382487959), who outlined three reasons this approach beats letting OpenClaw handle API interactions directly: observability through n8n\'s visual UI, security through credential isolation, and performance by running deterministic sub-tasks as workflows instead of LLM calls. The [openclaw-n8n-stack](https://github.com/caprihan/openclaw-n8n-stack) repository provides a ready-to-run Docker Compose setup implementing this pattern.\n\n## Related Links\n\n- [n8n Documentation](https://docs.n8n.io/)\n- [openclaw-n8n-stack (Docker setup)](https://github.com/caprihan/openclaw-n8n-stack)\n- [n8n Webhook Trigger Docs](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.webhook/)\n',
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- test-runner\n- api-tester\n- rss-reader\n- json-transformer\n- spreadsheet-reader\n- email-draft\n- slack-poster\n- notification-sender\n- file-reader\n- file-writer\n',
  ...
  {
    id: 'awesome-n8n-workflow-orchestration-proxy-pattern',
    name: 'Proxy pattern Boo',
    role: 'Proxy pattern',
    emoji: '🛠️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'n8n-workflow-orchestration', 'proxy', 'pattern'],
    skillIds: [
      'bash-executor',
      'test-runner',
      'api-tester',
  ...
  {
    id: 'awesome-n8n-workflow-orchestration-safeguard-steps',
    name: 'Safeguard steps Boo',
    role: 'Safeguard steps',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Letting your AI agent directly manage API keys and call external services is a recipe for security incidents. Every new integration means another credential ...',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'n8n-workflow-orchestration', 'safeguard', 'steps'],
    skillIds: [
      'bash-executor',
      'test-runner',
      'api-tester',
  ...
  {
    id: 'awesome-n8n-workflow-orchestration-visual-debugging',
    name: 'Visual debugging Boo',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'n8n-workflow-orchestration', 'visual', 'debugging'],
    skillIds: [
      'bash-executor',
      'test-runner',
      'api-tester',
  ...
  {
    id: 'awesome-overnight-mini-app-builder-operator',
    name: 'Overnight Mini App Builder Operator Boo',
    role: 'Overnight Mini App Builder Operator',
    emoji: '⚙️',
    color: '#A855F7',
    description:
      'Your AI agent is powerful but reactive — it only works when you tell it what to do. What if it knew your goals and proactively came up with tasks to move you...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/overnight-mini-app-builder.md',
    domain: 'openclaw',
    category: 'engineering',
    tags: ['openclaw', 'overnight-mini-app-builder', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'file-reader',
  ...
  {
    id: 'awesome-personal-crm-operator',
    name: 'Personal Crm Operator Boo',
    role: 'Personal Crm Operator',
    emoji: '💼',
    color: '#A855F7',
    description:
      "Keeping track of who you've met, when, and what you discussed is impossible to do manually. Important follow-ups slip through the cracks, and you forget cont...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/personal-crm.md',
    domain: 'openclaw',
    category: 'sales',
    tags: ['openclaw', 'personal-crm', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'sql-query',
  ...
  {
    id: 'awesome-phone-based-personal-assistant-operator',
    name: 'Phone Based Personal Assistant Operator Boo',
    role: 'Phone Based Personal Assistant Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
      'You want to access your AI agent from any phone without needing a smartphone app or internet browser. You need hands-free voice assistance while driving, wal...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/phone-based-personal-assistant.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'phone-based-personal-assistant', 'operator'],
    skillIds: ['code-search', 'web-search', 'api-tester', 'rss-reader', 'calendar-manager'],
    soulTemplate:
      '# Phone Based Personal Assistant Operator\n\n# Phone-Based Personal Assistant\n\n## Pain Point\n\nYou want to access your AI agent from any phone without needing a smartphone app or internet browser. You need hands-free voice assistance while driving, walking, or when your hands are occupied.\n\n## What It Does\n\nClawdTalk enables OpenClaw to receive and make phone calls, turning any phone into a gateway to your AI assistant. You can:\n- Call a phon\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-phone-call-notifications-operator',
    name: 'Phone Call Notifications Operator Boo',
    role: 'Phone Call Notifications Operator',
    emoji: '✨',
    color: '#A855F7',
    description:
      'Your agent already monitors things for you — stocks, emails, smart home, calendars — but notifications are easy to ignore. Push notifications pile up. Chat m...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/phone-call-notifications.md',
    domain: 'openclaw',
    category: 'general',
    tags: ['openclaw', 'phone-call-notifications', 'operator'],
    skillIds: [
      'api-tester',
      'rss-reader',
      'email-draft',
  ...
  {
    id: 'awesome-podcast-production-pipeline-episode-description',
    name: 'Episode Description Boo',
    role: 'Episode Description',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'You have a podcast idea, maybe even a backlog of episode topics. But between researching guests, writing outlines, drafting intros, generating show notes, an...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/podcast-production-pipeline.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'podcast-production-pipeline', 'episode', 'description'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-podcast-production-pipeline-episode-research',
    name: 'Episode Research Boo',
    role: 'Episode Research',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'You have a podcast idea, maybe even a backlog of episode topics. But between researching guests, writing outlines, drafting intros, generating show notes, an...',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'podcast-production-pipeline', 'episode', 'research'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-podcast-production-pipeline-operator',
    name: 'Podcast Production Pipeline Operator Boo',
    role: 'Podcast Production Pipeline Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'You have a podcast idea, maybe even a backlog of episode topics. But between researching guests, writing outlines, drafting intros, generating show notes, an...',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'podcast-production-pipeline', 'operator'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
    ...
    soulTemplate:
      '# Podcast Production Pipeline Operator\n\n# Podcast Production Pipeline\n\nYou have a podcast idea, maybe even a backlog of episode topics. But between researching guests, writing outlines, drafting intros, generating show notes, and writing social media posts for promotion — the production overhead kills your momentum. What if you handed off a topic and got back a full production package?\n\nThis use case chains agents together to handle the\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
      "# Podcast Production Pipeline\n\nYou have a podcast idea, maybe even a backlog of episode topics. But between researching guests, writing outlines, drafting intros, generating show notes, and writing social media posts for promotion — the production overhead kills your momentum. What if you handed off a topic and got back a full production package?\n\nThis use case chains agents together to handle the entire podcast production workflow from topic to publish-ready assets.\n\n## Pain Point\n\nSolo podcasters and small teams spend more time on production than on actually recording. Research takes hours, show notes are an afterthought, and social media promotion is the first thing that gets skipped. The creative part — the conversation — is maybe 30% of the total effort. This agent handles the other 70%.\n\n## What It Does\n\n- **Episode Research** — given a topic or guest name, compiles background research, talking points, and suggested questions\n- **Outline & Script** — generates a structured episode outline with intro script, segment transitions, and closing remarks\n- **Show Notes** — after recording, processes the transcript into timestamped show notes with links to everything mentioned\n- **Social Media Kit** — creates promotional posts for X, LinkedIn, and Instagram with episode highlights and pull quotes\n- **Episode Description** — writes SEO-optimized episode descriptions for Spotify, Apple Podcasts, and YouTube\n\n## Skills You Need\n\n- Web search / research skill (for guest research and topic deep-dives)\n- File system access (for reading transcripts and writing output files)\n- Slack, Discord, or Telegram integration (for delivering assets)\n- Optional: `sessions_spawn` for running research and writing agents in parallel\n- Optional: RSS feed skill (for monitoring competitor podcasts)\n\n## How to Set It Up\n\n1. Pre-recording — generate research and outline:\n```text\nI'm recording a podcast episode about [TOPIC]. My guest is [NAME].\n\nPlease:\n1. Research the guest — their background, recent work, hot takes, and\n   anything controversial or interesting they've said publicly.\n2. Research the topic — key trends, recent news, common misconceptions,\n   and what the audience likely already knows vs. what would surprise them.\n3. Generate an episode outline:\n   - Cold open hook (1-2 sentences to grab attention)\n   - Intro script (30 seconds, casual tone)\n   - 5-7 interview questions, ordered from easy/rapport-building to deep/provocative\n   - 2-3 \"back pocket\" questions in case the conversation stalls\n   - Closing segment with call-to-action\n\nSave everything to ~/podcast/episodes/[episode-number]/prep/\n```\n\n2. Post-recording — generate show notes and promo:\n```text\nHere's the transcript for Episode [NUMBER]: [paste or point to file]\n\nPlease:\n1. Write timestamped show notes — every major topic shift gets a timestamp\n   and one-line summary. Include links to anything mentioned (tools, books,\n   articles, people).\n2. Write an episode description (max 200 words) optimized for podcast\n   search. Include 3-5 relevant keywords naturally.\n3. Create social media posts:\n   - X/Twitter: 3 tweets — one pull quote, one key insight, one question\n     to spark discussion. Each under 280 chars.\n   - LinkedIn: 1 post, professional tone, 100-150 words.\n   - Instagram caption: 1 post with emoji, casual tone, include relevant hashtags.\n4. Extract a \"highlights\" list — the 3 most interesting/surprising moments\n   with timestamps.\n\nSave everything to ~/podcast/episodes/[episode-number]/publish/\n```\n\n3. Optional — competitor monitoring:\n```text\nMonitor these podcast RSS feeds daily:\n- [feed URL 1]\n- [feed URL 2]\n\nWhen a new episode drops that covers a topic relevant to my podcast,\nsend me a Telegram message with:\n- Episode title and link\n- One-sentence summary\n- Whether this is something I should respond to or cover from my angle\n```\n\n## Key Insights\n\n- The **pre-recording research** is where most value is. Walking into an interview with deep guest research makes the conversation dramatically better — and that's something you can't fake in post-production.\n- Show notes with timestamps are a huge listener retention tool. Most podcasters skip them because they're tedious. This agent makes them effortless.\n- The social media kit saves the most *recurring* time. You need promo for every single episode, and it's always the same structure — perfect for automation.\n- Pairs well with the [Multi-Agent Content Factory](content-factory.md) if you want to repurpose podcast content into blog posts, newsletters, or video clips.\n\n## Related Links\n\n- [Podcast RSS Feed Spec](https://podcasters.apple.com/support/823-podcast-requirements)\n- [Spotify for Podcasters](https://podcasters.spotify.com/)\n- [Whisper (OpenAI)](https://github.com/openai/whisper) — for local transcript generation\n",
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- code-search\n- web-search\n- rss-reader\n- slack-poster\n- meeting-notes\n- file-reader\n- file-writer\n- zip-handler\n- note-taker\n- trend-analyzer\n- summarizer\n',
  ...
  {
    id: 'awesome-podcast-production-pipeline-outline-script',
    name: 'Outline & Script Boo',
    role: 'Outline & Script',
    emoji: '✍️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'podcast-production-pipeline', 'outline', 'script'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-podcast-production-pipeline-show-notes',
    name: 'Show Notes Boo',
    role: 'Show Notes',
    emoji: '✍️',
    color: '#A855F7',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'podcast-production-pipeline', 'show', 'notes'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-podcast-production-pipeline-social-media-kit',
    name: 'Social Media Kit Boo',
    role: 'Social Media Kit',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'You have a podcast idea, maybe even a backlog of episode topics. But between researching guests, writing outlines, drafting intros, generating show notes, an...',
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'podcast-production-pipeline', 'social', 'media', 'kit'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-polymarket-autopilot-operator',
    name: 'Polymarket Autopilot Operator Boo',
    role: 'Polymarket Autopilot Operator',
    emoji: '📣',
    color: '#A855F7',
    description:
      'Manually monitoring prediction markets for arbitrage opportunities and executing trades is time-consuming and requires constant attention. You want to test a...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/polymarket-autopilot.md',
    domain: 'openclaw',
    category: 'marketing',
    tags: ['openclaw', 'polymarket-autopilot', 'operator'],
    skillIds: [
      'code-search',
      'test-runner',
      'api-tester',
  ...
  {
    id: 'awesome-pre-build-idea-validator-operator',
    name: 'Pre Build Idea Validator Operator Boo',
    role: 'Pre Build Idea Validator Operator',
    emoji: '📣',
    color: '#A855F7',
    description:
      'Before OpenClaw starts building anything new, it automatically checks whether the idea already exists across GitHub, Hacker News, npm, PyPI, and Product Hunt...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/pre-build-idea-validator.md',
    domain: 'openclaw',
    category: 'marketing',
    tags: ['openclaw', 'pre-build-idea-validator', 'operator'],
    skillIds: ['rss-reader', 'json-transformer'],
    soulTemplate:
      '# Pre Build Idea Validator Operator\n\n# Pre-Build Idea Validator\n\nBefore OpenClaw starts building anything new, it automatically checks whether the idea already exists across GitHub, Hacker News, npm, PyPI, and Product Hunt — and adjusts its approach based on what it finds.\n\n## What It Does\n\n- Scans 5 real data sources (GitHub, Hacker News, npm, PyPI, Product Hunt) before any code is written\n- Returns a `reality_signal` score (0-100)\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-project-state-management-operator',
    name: 'Project State Management Operator Boo',
    role: 'Project State Management Operator',
    emoji: '📋',
    color: '#A855F7',
    description:
      'Traditional Kanban boards are static and require manual updates. You forget to move cards, lose context between sessions, and can\'t track the "why" behind st...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/project-state-management.md',
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'project-state-management', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'web-scraper',
  ...
  {
    id: 'awesome-second-brain-operator',
    name: 'Second Brain Operator Boo',
    role: 'Second Brain Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
      'You come up with ideas, find interesting links, hear about books to read — but you never have a good system for capturing them. Notion gets complex, Apple No...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/second-brain.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'second-brain', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'pdf-reader',
  ...
  {
    id: 'awesome-self-healing-home-server-automated-health-monitoring',
    name: 'Automated health monitoring Boo',
    role: 'Automated health monitoring',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Running a home server means being on-call 24/7 for your own infrastructure. Services go down at 3 AM, certificates expire silently, disk fills up, and pods c...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/self-healing-home-server.md',
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'automated', 'health', 'monitoring'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-self-healing-home-server-blog-publishing-pipeline',
    name: 'Blog publishing pipeline Boo',
    role: 'Blog publishing pipeline',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Running a home server means being on-call 24/7 for your own infrastructure. Services go down at 3 AM, certificates expire silently, disk fills up, and pods c...',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'blog', 'publishing', 'pipeline'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-self-healing-home-server-email-triage',
    name: 'Email triage Boo',
    role: 'Email triage',
    emoji: '🛠️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'email', 'triage'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-self-healing-home-server-infrastructure-management',
    name: 'Infrastructure management Boo',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'infrastructure', 'management'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-self-healing-home-server-knowledge-extraction',
    name: 'Knowledge extraction Boo',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'knowledge', 'extraction'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-self-healing-home-server-morning-briefings',
    name: 'Morning briefings Boo',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'morning', 'briefings'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-self-healing-home-server-operator',
    name: 'Self Healing Home Server Operator Boo',
    role: 'Self Healing Home Server Operator',
    emoji: '🛠️',
    color: '#A855F7',
    description:
      'Running a home server means being on-call 24/7 for your own infrastructure. Services go down at 3 AM, certificates expire silently, disk fills up, and pods c...',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'operator'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
    ...
    soulTemplate:
      "# Self Healing Home Server Operator\n\n# Self-Healing Home Server & Infrastructure Management\n\nRunning a home server means being on-call 24/7 for your own infrastructure. Services go down at 3 AM, certificates expire silently, disk fills up, and pods crash-loop — all while you're asleep or away.\n\nThis use case turns OpenClaw into a persistent infrastructure agent with SSH access, automated cron jobs, and the ability to detect, diagnose\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
      "# Self-Healing Home Server & Infrastructure Management\n\nRunning a home server means being on-call 24/7 for your own infrastructure. Services go down at 3 AM, certificates expire silently, disk fills up, and pods crash-loop — all while you're asleep or away.\n\nThis use case turns OpenClaw into a persistent infrastructure agent with SSH access, automated cron jobs, and the ability to detect, diagnose, and fix issues before you know there's a problem.\n\n## Pain Point\n\nHome lab operators and self-hosters face a constant maintenance burden:\n\n- Health checks, log monitoring, and alerting require manual setup and attention\n- When something breaks, you have to SSH in, diagnose, and fix — often from your phone\n- Infrastructure-as-code (Terraform, Ansible, Kubernetes manifests) needs regular updates\n- Knowledge about your setup lives in your head, not in searchable documentation\n- Routine tasks (email triage, deployment checks, security audits) eat hours every week\n\n## What It Does\n\n- **Automated health monitoring**: Cron-based checks on services, deployments, and system resources\n- **Self-healing**: Detects issues via health checks and applies fixes autonomously (restart pods, scale resources, fix configs)\n- **Infrastructure management**: Writes and applies Terraform, Ansible, and Kubernetes manifests\n- **Morning briefings**: Daily summary of system health, calendar, weather, and task board status\n- **Email triage**: Scans inbox, labels actionable items, archives noise\n- **Knowledge extraction**: Processes notes and conversation exports into a structured, searchable knowledge base\n- **Blog publishing pipeline**: Draft → generate banner → publish to CMS → deploy to hosting — fully automated\n- **Security auditing**: Regular scans for hardcoded secrets, privileged containers, and overly permissive access\n\n## Skills You Need\n\n- `ssh` access to home network machines\n- `kubectl` for Kubernetes cluster management\n- `terraform` and `ansible` for infrastructure-as-code\n- `1password` CLI for secrets management\n- `gog` CLI for email access\n- Calendar API access\n- Obsidian vault or notes directory (for knowledge base)\n- `openclaw doctor` for self-diagnostics\n\n## How to Set It Up\n\n### 1. Core Agent Configuration\n\nName your agent and define its access scope in AGENTS.md:\n\n```text\n## Infrastructure Agent\n\nYou are Reef, an infrastructure management agent.\n\nAccess:\n- SSH to all machines on the home network (192.168.1.0/24)\n- kubectl for the K3s cluster\n- 1Password vault (read-only for credentials, dedicated AI vault)\n- Gmail via gog CLI\n- Calendar (yours + partner's)\n- Obsidian vault at ~/Documents/Obsidian/\n\nRules:\n- NEVER hardcode secrets — always use 1Password CLI or environment variables\n- NEVER push directly to main — always create a PR\n- Run `openclaw doctor` as part of self-health checks\n- Log all infrastructure changes to ~/logs/infra-changes.md\n```\n\n### 2. Automated Cron Job System\n\nThe power of this setup is the scheduled job system. Configure in HEARTBEAT.md:\n\n```text\n## Cron Schedule\n\nEvery 15 minutes:\n- Check kanban board for in-progress tasks → continue work\n\nEvery hour:\n- Monitor health checks (Gatus, ArgoCD, service endpoints)\n- Triage Gmail (label actionable items, archive noise)\n- Check for unanswered alerts or notifications\n\nEvery 6 hours:\n- Knowledge base data entry (process new Obsidian notes)\n- Self health check (openclaw doctor, disk usage, memory, logs)\n\nEvery 12 hours:\n- Code quality and documentation audit\n- Log analysis via Loki/monitoring stack\n\nDaily:\n- 4:00 AM: Nightly brainstorm (explore connections between notes)\n- 8:00 AM: Morning briefing (weather, calendars, system stats, task board)\n- 1:00 AM: Velocity assessment (process improvements)\n\nWeekly:\n- Knowledge base QA review\n- Infrastructure security audit\n```\n\n### 3. Security Setup (Critical)\n\nThis is non-negotiable. Before giving your agent SSH access:\n\n```text\n## Security Checklist\n\n1. Pre-push hooks:\n   - Install TruffleHog or similar secret scanner on ALL repositories\n   - Block any commit containing hardcoded API keys, tokens, or passwords\n\n2. Local-first Git workflow:\n   - Use Gitea (self-hosted) for private code before pushing to public GitHub\n   - CI scanning pipeline (Woodpecker or similar) runs before any public push\n   - Human review required before main branch merges\n\n3. Defense in depth:\n   - Dedicated 1Password vault for AI agent (limited scope)\n   - Network segmentation for sensitive services\n   - Daily automated security audits checking for:\n     * Privileged containers\n     * Hardcoded secrets in code or configs\n     * Overly permissive file/network access\n     * Known vulnerabilities in deployed images\n\n4. Agent constraints:\n   - Branch protection: PR required for main, agent cannot override\n   - Read-only access where write isn't needed\n   - All changes logged and auditable via git\n```\n\n### 4. Morning Briefing Template\n\n```text\n## Daily Briefing Format\n\nGenerate and deliver at 8:00 AM:\n\n### Weather\n- Current conditions and forecast for [your location]\n\n### Calendars\n- Your events today\n- Partner's events today\n- Conflicts or overlaps flagged\n\n### System Health\n- CPU / RAM / Storage across all machines\n- Services: UP/DOWN status\n- Recent deployments (ArgoCD)\n- Any alerts in last 24h\n\n### Task Board\n- Cards completed yesterday\n- Cards in progress\n- Blocked items needing attention\n\n### Highlights\n- Notable items from nightly brainstorm\n- Emails requiring action\n- Upcoming deadlines this week\n```\n\n## Key Insights\n\n- **\"I can't believe I have a self-healing server now\"**: The agent can run SSH, Terraform, Ansible, and kubectl commands to fix infrastructure issues before you even know there's a problem\n- **AI will hardcode secrets**: This is the #1 security risk. The agent will happily put an API key inline in code if you don't enforce guardrails. Pre-push hooks and secret scanning are mandatory\n- **Local-first Git is essential**: Never let the agent push directly to public repositories. Use a private Gitea instance as a staging area with CI scanning\n- **Cron jobs are the real product**: The scheduled automation (health checks, email triage, briefings) provides more daily value than ad-hoc commands\n- **Knowledge extraction compounds**: Processing notes, conversation exports, and emails into a structured knowledge base gets more valuable over time — one user extracted 49,079 atomic facts from their ChatGPT history alone\n\n## Inspired By\n\nThis use case is based on Nathan's detailed writeup [\"Everything I've Done with OpenClaw (So Far)\"](https://madebynathan.com/2026/02/03/everything-ive-done-with-openclaw-so-far/), where he describes his OpenClaw agent \"Reef\" running on a home server with SSH access to all machines, a Kubernetes cluster, 1Password integration, and an Obsidian vault with 5,000+ notes. Reef runs 15 active cron jobs, 24 custom scripts, and has autonomously built and deployed applications including a task management UI. Nathan's hard-won lesson after a Day 1 API key exposure: \"AI assistants will happily hardcode secrets. They sometimes don't have the same instincts humans do.\" His defense-in-depth security setup (TruffleHog pre-push hooks, local Gitea, CI scanning, daily audits) is essential reading for anyone attempting this pattern.\n\nAlso referenced on the [OpenClaw Showcase](https://openclaw.ai/showcase), where `@georgedagg_` described a similar pattern: deployment monitoring, log review, configuration fixes, and PR submissions — all while walking the dog.\n\n## Related Links\n\n- [Nathan's Full Writeup](https://madebynathan.com/2026/02/03/everything-ive-done-with-openclaw-so-far/)\n- [OpenClaw Documentation](https://github.com/openclaw/openclaw)\n- [TruffleHog (Secret Scanning)](https://github.com/trufflesecurity/trufflehog)\n- [K3s (Lightweight Kubernetes)](https://k3s.io/)\n- [Gitea (Self-hosted Git)](https://gitea.io/)\n- [n8n (Workflow Automation)](https://n8n.io/)\n",
    toolsTemplate:
      '# TOOLS\n\n## Skills\n- bash-executor\n- code-search\n- test-runner\n- linter\n- web-scraper\n- pdf-reader\n- api-tester\n- rss-reader\n- email-draft\n- slack-poster\n- notification-sender\n- calendar-manager\n- meeting-notes\n- file-reader\n- file-writer\n- zip-handler\n- note-taker\n- summarizer\n',
  ...
  {
    id: 'awesome-self-healing-home-server-security-auditing',
    name: 'Security auditing Boo',
    ...
    domain: 'openclaw',
    category: 'devops',
    tags: ['openclaw', 'self-healing-home-server', 'security', 'auditing'],
    skillIds: [
      'bash-executor',
      'code-search',
      'test-runner',
  ...
  {
    id: 'awesome-semantic-memory-search-operator',
    name: 'Semantic Memory Search Operator Boo',
    role: 'Semantic Memory Search Operator',
    emoji: '🔬',
    color: '#A855F7',
    description:
      "OpenClaw's built-in memory system stores everything as markdown files — but as memories grow over weeks and months, finding that one decision from last Tuesd...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/semantic-memory-search.md',
    domain: 'openclaw',
    category: 'research',
    tags: ['openclaw', 'semantic-memory-search', 'operator'],
    skillIds: [
      'code-search',
      'python-executor',
      'web-search',
  ...
  {
    id: 'awesome-todoist-task-manager-operator',
    name: 'Todoist Task Manager Operator Boo',
    role: 'Todoist Task Manager Operator',
    emoji: '📋',
    color: '#A855F7',
    description:
    ...
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/todoist-task-manager.md',
    domain: 'openclaw',
    category: 'ops',
    tags: ['openclaw', 'todoist-task-manager', 'operator'],
    skillIds: [
      'bash-executor',
      'web-search',
      'api-tester',
    ...
    soulTemplate:
      '# Todoist Task Manager Operator\n\n# Todoist Task Manager: Agent Task Visibility\nMaximize transparency for long-running agentic workflows by syncing internal reasoning and progress logs directly to Todoist.\n\n## Pain Point\nWhen agents run complex, multi-step tasks (like building a full-stack app or performing deep research), the user often loses track of what the agent is currently doing, what steps have been completed, and where th\n\n<!-- TODO: review soul extraction -->',
    identityTemplate:
  ...
  {
    id: 'awesome-x-account-analysis-operator',
    name: 'X Account Analysis Operator Boo',
    role: 'X Account Analysis Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      "There are many websites designed to give you a qualitative analysis of your X account. While X already gives you an **analytics** section, it's more focused ...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/x-account-analysis.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'x-account-analysis', 'operator'],
    skillIds: ['code-search', 'linter', 'csv-analyzer', 'file-writer', 'trend-analyzer'],
    soulTemplate:
      "# X Account Analysis Operator\n\n# X Account Analysis\n\nThere are many websites designed to give you a qualitative analysis of your X account. While X already gives you an **analytics** section, it's more focused to show your numbers on your performance.\n\nBut a qualitative analysis focuses on the quality of your posts, not the performance stats. Some insights you can get from this type of analysis:\n- What are the patterns that mak\n\n<!-- TODO: review soul extraction -->",
    identityTemplate:
  ...
  {
    id: 'awesome-x-twitter-automation-operator',
    name: 'X Twitter Automation Operator Boo',
    role: 'X Twitter Automation Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      'Full X/Twitter automation through natural language — post tweets, reply, like, retweet, follow, DM, search, extract data, run giveaways, and monitor accounts...',
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/x-twitter-automation.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'x-twitter-automation', 'operator'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-x-twitter-automation-post-engage',
    name: 'Post & engage Boo',
    role: 'Post & engage',
    emoji: '✍️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'x-twitter-automation', 'post', 'engage'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-x-twitter-automation-search-extract',
    name: 'Search & extract Boo',
    role: 'Search & extract',
    emoji: '✍️',
    color: '#A855F7',
    description:
    ...
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'x-twitter-automation', 'search', 'extract'],
    skillIds: [
      'bash-executor',
      'code-search',
      'web-search',
  ...
  {
    id: 'awesome-youtube-content-pipeline-operator',
    name: 'Youtube Content Pipeline Operator Boo',
    role: 'Youtube Content Pipeline Operator',
    emoji: '✍️',
    color: '#A855F7',
    description:
      "As a daily YouTube creator, finding fresh, timely video ideas across the web and X/Twitter is time-consuming. Tracking what you've already covered prevents d...",
    source: 'awesome-openclaw',
    sourceUrl:
      'https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/659895e58e2105c6db8fbef39f446c8a786a480c/usecases/youtube-content-pipeline.md',
    domain: 'openclaw',
    category: 'content',
    tags: ['openclaw', 'youtube-content-pipeline', 'operator'],
    skillIds: [
      'code-search',
      'web-search',
      'rss-reader',
