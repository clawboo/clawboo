...
import type { BoardClient, BoardTask, CompleteExecutionOutcome } from '@/lib/boardClient'
import { buildTaskUpdateMessage, type TaskUpdateOutcome } from '@/lib/teamProtocol'
...
export interface BoardOrchestrator {
   ...
   * never left standing. Driven by an interval in `useBoardOrchestration`.
   */
