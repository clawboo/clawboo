...
`pnpm install` resolves the whole workspace, the three globs `packages/*`, `packages/adapters/*`, and `apps/*` (see [Monorepo and build](/internals/monorepo-and-build) for the layout).
