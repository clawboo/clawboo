---
title: Changelog
description: Release history of the clawboo CLI from the 0.1.0 name-claim placeholder through v0.2.0, the liberated cut.
---
...
| 0.2.0 | _(untagged)_ | _not yet_ | The liberated cut, full multi-runtime orchestrator |
...
- [Known issues](/appendices/known-issues), the v0.2.0-committed-but-unpublished gap and other candid limitations
