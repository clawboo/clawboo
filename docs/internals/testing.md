...
Four tests in the suite aren't testing features; they're freezing structural invariants of the repo itself. They run inside `pnpm test` like any other test, and they fail the build the moment an invariant drifts.
