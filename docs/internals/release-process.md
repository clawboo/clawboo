...
2. **Pass CI.** The seven jobs (`lint`, `typecheck`, `test`, `build`, `verify-ingest`, `smoke-test-bundle`, `e2e`) must all be green, as must CodeQL. The bundle smoke test runs on Ubuntu and Windows.
