...
| Start a fresh conversation  | `/reset` or `/new`                                         | Ends what every teammate is carrying and drops a divider. No message is removed. See [Agents](/using/agents) |
